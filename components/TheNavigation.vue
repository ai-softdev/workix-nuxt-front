      ...
      <NavigationBlock>
        ...
        <template v-slot:navContent>
            ...
            <template v-slot:navIcon>
              <svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none"
                ...
                <path
                    ...
                    stroke-width="1.5"/>
                <path stroke="currentColor" d="M9 13H15" stroke-width="1.5" stroke-linecap="round"/>
                <path stroke="currentColor" d="M9 9H15" stroke-width="1.5" stroke-linecap="round"/>
                <path stroke="currentColor" d="M9 17H12" stroke-width="1.5" stroke-linecap="round"/>
              </svg>
            </template>
            <template v-slot:navLink>
              <p>{{ $t('Документы') }}</p>
          ...
          <NavigationLink
            ...
            <template v-slot:navIcon>
              <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                   ...
                   viewBox="0 0 511 511.997" xml:space="preserve"><g>
          ...
          <NavigationLink v-if="loadCurrentUser.user.role.name_en !== 'admin'"
            ...
            <template v-slot:navIcon>
              <svg
                  fill="none" width="25px" height="25px" viewBox="0 0 24 24"
                   xmlns="http://www.w3.org/2000/svg">
                <path
                    stroke="currentColor"
          ...
          <NavigationLink
              ...
              class="flex items-center gap-x-6">
            <template v-slot:navIcon>
              <svg width="25px" height="25px" viewBox="0 0 32 32" id="icon"
                   xmlns="http://www.w3.org/2000/svg">
                <path
                    stroke="currentColor"
          ...
          <NavigationLink
            ...
            <template v-slot:navIcon>
              <svg width="25px" height="25px" viewBox="0 0 24 24" fill="none"
                ...
                <path
                    stroke="currentColor"
                    d="M20.3873 7.1575L11.9999 12L3.60913 7.14978" stroke-width="1.3" stroke-linecap="round"
                      stroke-linejoin="round"/>
                <path
                    stroke="currentColor"
                    d="M12 12V21" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
                <path
                    stroke="currentColor"
