      ...
      <NavigationBlock>
        ...
        <template v-slot:navTitleIcon>
          <div v-if="!loadCurrentUser.user.company_logo_url" class="dark:fill-white fill-black px-2">
            <svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M9 12.7278V9.52783M9 6.32783H9.008M17 9.52783C17 13.9461 13.4182 17.5278 9 17.5278C4.58172 17.5278 1 13.9461 1 9.52783C1 5.10955 4.58172 1.52783 9 1.52783C13.4182 1.52783 17 5.10955 17 9.52783Z" stroke="black" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          ...
          <NavigationLink
            ...
            <template v-slot:navIcon>
              <svg class="fill-black dark:fill-white" xmlns="http://www.w3.org/2000/svg" version="1.1"
                  ...
                  class="fill-black dark:fill-white" opacity="1" data-original="#000000"></path></g></svg>
            </template>
            <template v-slot:navLink>
              <p>{{ $t('Продажи') }}</p>
            </template>
        ...
        <template v-slot:navTitleIcon>
          <div class="dark:fill-white fill-black ml-1.5">
            <svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M12 13.5278C12.5523 13.5278 13 13.0801 13 12.5278C13 11.9755 12.5523 11.5278 12 11.5278C11.4477 11.5278 11 11.9755 11 12.5278C11 13.0801 11.4477 13.5278 12 13.5278Z" fill="black" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M19 13.5278C19.5523 13.5278 20 13.0801 20 12.5278C20 11.9755 19.5523 11.5278 19 11.5278C18.4477 11.5278 18 11.9755 18 12.5278C18 13.0801 18.4477 13.5278 19 13.5278Z" fill="black" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
              <path d="M5 13.5278C5.55228 13.5278 6 13.0801 6 12.5278C6 11.9755 5.55228 11.5278 5 11.5278C4.44772 11.5278 4 11.9755 4 12.5278C4 13.0801 4.44772 13.5278 5 13.5278Z" fill="black" stroke="black" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
        </template>
        <template v-slot:navContent>
        ...
        >
          <div class="w-10 h-10 rounded-lg border flex items-center justify-center">
            <svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M4.2 4.7998L1 7.9998M1 7.9998L4.2 11.1998M1 7.9998H11.4M6.6 1.76304C7.61984 1.15042 8.80384 0.799805 10.0666 0.799805C13.8958 0.799805 17 4.02336 17 7.9998C17 11.9763 13.8958 15.1998 10.0666 15.1998C8.80384 15.1998 7.61984 14.8492 6.6 14.2366" stroke="#2A2A2A" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
          </div>
          <p v-if="loadCurrentUser.activeNav" class="font-medium text-sm dark:text-white text-black">{{ $t("Выйти") }}</p>
        </TheButton>
      </div>
    </div>
  </div>
