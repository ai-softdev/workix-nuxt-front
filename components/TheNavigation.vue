  ...
  <div class="container z-50 relative shadow-lg dark:border-none"
    ...
    <div
      ...
      <NavigationBlock>
        ...
        <template v-slot:navContent>
          <NavigationLink v-if="loadCurrentUser.user.role_en !== 'admin'" :to="`/base/documents`"
                          class="flex items-center gap-x-6">
            <template v-slot:navIcon>
              <svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
          ...
          <NavigationLink v-if="loadCurrentUser.user.role_en !== 'admin'" to="/base/tree"
                          class="flex items-center gap-x-6">
            <template v-slot:navIcon>
          ...
          <NavigationLink v-if="loadCurrentUser.user.role_en !== 'admin'" to="/base/objects"
                          class="flex items-center gap-x-6">
            <template v-slot:navIcon>
              <svg width="25px" height="25px" class="stroke-black dark:stroke-white" viewBox="0 0 24 24" fill="none"
                   xmlns="http://www.w3.org/2000/svg">
      ...
      <NavigationBlock>
        ...
        <template v-slot:navContent>
          <NavigationLink v-if="loadCurrentUser.user.role_en !== 'admin'" to="/base/chat"
                          class="flex items-center gap-x-6">
            <template v-slot:navIcon>
          ...
          <NavigationLink v-if="loadCurrentUser.user.role_en !== 'admin'" to="/base/cloud"
                          class="flex items-center gap-x-6">
            <template v-slot:navIcon>
