...
const _routes = [
  {
    ...
    component: () => import("./_nuxt/base-D57a_nsc.js").then((m) => m.default || m),
    children: [
      {
        name: "base-chat",
        path: "chat",
        ...
        children: [
          {
            ...
            component: () => import("./_nuxt/_id_-CaMgHaLd.js").then((m) => m.default || m)
          }
        ]
      },
      {
      ...
      },
      {
        ...
        component: () => import("./_nuxt/index-DGFPE4fn.js").then((m) => m.default || m)
      },
      {
        name: "base-companies",
        path: "companies",
      ...
      },
      {
        ...
        component: () => import("./_nuxt/profile-51aXr8Rx.js").then((m) => m.default || m)
      },
      {
        name: "base-sales",
        path: "sales",
        ...
        component: () => import("./_nuxt/index-9wfZisf8.js").then((m) => m.default || m)
      },
      {
      ...
      },
      {
        ...
        component: () => import("./_nuxt/_slug_-Dg3oTGmV.js").then((m) => m.default || m)
      },
      {
        name: "base-users",
        path: "users",
        ...
        component: () => import("./_nuxt/index-BP94JjkU.js").then((m) => m.default || m)
      }
    ]
  },
  {
