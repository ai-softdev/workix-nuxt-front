...
import { _ as _sfc_main$4 } from "./TheModal-CnBva0fQ.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.showCreate) {
        _push(ssrRenderComponent(_sfc_main$4, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<p class="text-center font-bold max-sm:w-9/12 max-sm:mx-auto"${_scopeId}>${ssrInterpolate(_ctx.$t("Создать департамент"))}</p><form${_scopeId}>`);
              ...
              _push2(`<div class="flex flex-wrap gap-y-3 items-center justify-center gap-x-10 max-sm:flex-col"${_scopeId}>`);
              ...
              return [
                createVNode("p", { class: "text-center font-bold max-sm:w-9/12 max-sm:mx-auto" }, toDisplayString(_ctx.$t("Создать департамент")), 1),
                createVNode("form", {
                  ...
                  createVNode("div", { class: "flex flex-wrap gap-y-3 items-center justify-center gap-x-10 max-sm:flex-col" }, [
...
//# sourceMappingURL=index-DvXR3Pqg.js.map
