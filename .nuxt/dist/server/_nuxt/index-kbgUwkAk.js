...
import { _ as _sfc_main$c } from "./TheTextContent-D3-WrEaf.js";
import { _ as _sfc_main$e } from "./TheSearch-Dw2_cWOE.js";
import { _ as _sfc_main$a } from "./TheButton-RleONNaZ.js";
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col overflow-hidden gap-y-10" }, _attrs))}><div class="grid grid-cols-3 gap-5 w-full"><div class="p-6 bg-white rounded-3xl"><div class="flex items-center gap-4 py-2 px-3 border rounded-full justify-center w-fit"><img${ssrRenderAttr("src", _imports_0)} alt="chart"> ${ssrInterpolate(_ctx.$t("График"))}</div><div class="mt-8">`);
...
//# sourceMappingURL=index-kbgUwkAk.js.map
