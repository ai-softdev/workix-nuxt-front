...
import { defineComponent, mergeProps, useSSRContext, unref, withCtx, openBlock, createBlock, createVNode, createTextVNode, toDisplayString, ref, computed, Transition, createCommentVNode, withDirectives, isRef, vModelText, Fragment, renderList, nextTick, onUnmounted, watch } from "vue";
...
import { _ as _sfc_main$a } from "./TheFileInput-D5TWNA_e.js";
import { Preview } from "vue-advanced-cropper";
import { _ as _sfc_main$b, a as _sfc_main$c } from "./TheChatAvatar-BbVdH2Rh.js";
        ...
        _push(ssrRenderComponent(_sfc_main$9, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<!--]--><div class="mt-4 text-sm"${_scopeId}><strong${_scopeId}>Выбранные ID:</strong> ${ssrInterpolate(unref(selectedIds))}</div><div class="w-full px-4 h-[50px] flex items-center justify-end text-sm gap-x-4"${_scopeId}>`);
              ...
              if (!unref(chat).showSettingChat) {
                _push2(ssrRenderComponent(_sfc_main$8, {
                  ...
                  onClick: ($event) => {
                    ...
                    console.log(typeof unref(selectedIds));
              ...
              return [
                ...
                createVNode("div", { class: "mt-4 text-sm" }, [
                  createVNode("strong", null, "Выбранные ID:"),
                  createTextVNode(" " + toDisplayString(unref(selectedIds)), 1)
                ]),
...
//# sourceMappingURL=chat-vSNGOKFO.js.map
