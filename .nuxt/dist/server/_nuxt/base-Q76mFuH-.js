import { defineComponent, withCtx, createTextVNode, toDisplayString, unref, useSSRContext, mergeProps, createVNode, renderSlot, ref, openBlock, createBlock, Transition, createCommentVNode, watchSyncEffect, watch, onUpdated } from "vue";
...
import { g as useState, i as useI18n, u as useHead, _ as __nuxt_component_0$2 } from "../server.mjs";
...
import { _ as _sfc_main$a, u as useTreeStore } from "./TheButton-RleONNaZ.js";
import { T as TheSceleton } from "./TheSceleton-CoixK6br.js";
import nuxtStorage from "nuxt-storage/nuxt-storage.js";
import { _ as _sfc_main$b } from "./TheModal-DcnSgpbI.js";
...
const _imports_0$1 = "" + __publicAssetsURL("icons/ru.svg");
const _imports_1 = "" + __publicAssetsURL("icons/us.svg");
const _imports_2 = "" + __publicAssetsURL("icons/exit.svg");
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (showExitModal.value) {
        _push(ssrRenderComponent(_sfc_main$b, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="p-8"${_scopeId}><p class="font-bold text-2xl text-center"${_scopeId}>${ssrInterpolate(_ctx.$t("Вы уверены что хотите выйти из аккаунта?"))}</p><div class="flex items-center justify-between mt-[56px]"${_scopeId}>`);
              ...
              return [
                createVNode("div", { class: "p-8" }, [
                  createVNode("p", { class: "font-bold text-2xl text-center" }, toDisplayString(_ctx.$t("Вы уверены что хотите выйти из аккаунта?")), 1),
                  createVNode("div", { class: "flex items-center justify-between mt-[56px]" }, [
    ...
    return (_ctx, _push, _parent, _attrs) => {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$3, { to: "/base/profile" }, {
              navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg width="25px" height="25px" class="stroke-black dark:stroke-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId2}><circle cx="12" cy="6" r="4" stroke-width="1.5" data-v-490f8cf8${_scopeId2}></circle><path d="M19.9975 18C20 17.8358 20 17.669 20 17.5C20 15.0147 16.4183 13 12 13C7.58172 13 4 15.0147 4 17.5C4 19.9853 4 22 12 22C14.231 22 15.8398 21.8433 17 21.5634" stroke="" stroke-width="1.5" stroke-linecap="round" data-v-490f8cf8${_scopeId2}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      width: "25px",
              ...
              navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Профиль"))}</p>`);
                } else {
                  return [
            ...
            if (((_c2 = (_b2 = (_a2 = unref(loadCurrentUser)) == null ? void 0 : _a2.user) == null ? void 0 : _b2.role) == null ? void 0 : _c2.name_en) !== "admin") {
              _push2(ssrRenderComponent(_sfc_main$3, { to: "/base/users" }, {
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId2}><g id="User / Users_Group" data-v-490f8cf8${_scopeId2}><path id="Vector" class="dark:stroke-white stroke-black" d="M17 20C17 18.3431 14.7614 17 12 17C9.23858 17 7 18.3431 7 20M21 17.0004C21 15.7702 19.7659 14.7129 18 14.25M3 17.0004C3 15.7702 4.2341 14.7129 6 14.25M18 10.2361C18.6137 9.68679 19 8.8885 19 8C19 6.34315 17.6569 5 16 5C15.2316 5 14.5308 5.28885 14 5.76389M6 10.2361C5.38625 9.68679 5 8.8885 5 8C5 6.34315 6.34315 5 8 5C8.76835 5 9.46924 5.28885 10 5.76389M12 14C10.3431 14 9 12.6569 9 11C9 9.34315 10.3431 8 12 8C13.6569 8 15 9.34315 15 11C15 12.6569 13.6569 14 12 14Z" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId2}></path></g></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        width: "25px",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Пользователи"))}</p>`);
                  } else {
                    return [
      ...
      if (((_c = (_b = (_a = unref(loadCurrentUser)) == null ? void 0 : _a.user) == null ? void 0 : _b.role) == null ? void 0 : _c.name_en) !== "admin" && isValidLink("tasks")) {
        _push(ssrRenderComponent(_sfc_main$2, null, {
          ...
          navTitleIcon: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="dark:fill-white fill-black px-1" data-v-490f8cf8${_scopeId}><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId}><path d="M4.2 11.9278L5.8 13.5278L9.4 9.92783M5.8 6.32783V4.08783C5.8 3.19175 5.8 2.7437 5.97439 2.40145C6.12778 2.10038 6.37255 1.85562 6.67362 1.70222C7.01587 1.52783 7.46392 1.52783 8.36 1.52783H14.44C15.3361 1.52783 15.7842 1.52783 16.1264 1.70222C16.4274 1.85562 16.6722 2.10038 16.8256 2.40145C17 2.7437 17 3.19175 17 4.08783V10.1678C17 11.0639 17 11.512 16.8256 11.8542C16.6722 12.1553 16.4274 12.4001 16.1264 12.5534C15.7842 12.7278 15.3361 12.7278 14.44 12.7278H12.2M3.56 17.5278H9.64C10.5361 17.5278 10.9842 17.5278 11.3264 17.3534C11.6274 17.2001 11.8722 16.9553 12.0256 16.6542C12.2 16.312 12.2 15.8639 12.2 14.9678V8.88783C12.2 7.99175 12.2 7.5437 12.0256 7.20145C11.8722 6.90038 11.6274 6.65562 11.3264 6.50222C10.9842 6.32783 10.5361 6.32783 9.64 6.32783H3.56C2.66392 6.32783 2.21587 6.32783 1.87362 6.50222C1.57255 6.65562 1.32778 6.90038 1.17439 7.20145C1 7.5437 1 7.99175 1 8.88783V14.9678C1 15.8639 1 16.312 1.17439 16.6542C1.32778 16.9553 1.57255 17.2001 1.87362 17.3534C2.21587 17.5278 2.66391 17.5278 3.56 17.5278Z" stroke="#2A2A2A" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId}></path></svg></div>`);
            } else {
              return [
            ...
            if (_push2) {
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("tasks")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg width="25px" height="25px" class="dark:fill-white fill-black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId2}><path d="M13.25 8.5C12.8358 8.5 12.5 8.83579 12.5 9.25C12.5 9.66421 12.8358 10 13.25 10H16.75C17.1642 10 17.5 9.66421 17.5 9.25C17.5 8.83579 17.1642 8.5 16.75 8.5H13.25Z" data-v-490f8cf8${_scopeId2}></path><path d="M12.5001 14.75C12.5001 14.3358 12.8358 14 13.2501 14H16.7499C17.1642 14 17.4999 14.3358 17.4999 14.75C17.4999 15.1642 17.1642 15.5 16.7499 15.5H13.2501C12.8358 15.5 12.5001 15.1642 12.5001 14.75Z" data-v-490f8cf8${_scopeId2}></path><path d="M10.7803 7.71967C11.0732 8.01256 11.0732 8.48744 10.7803 8.78033L8.78033 10.7803C8.48744 11.0732 8.01256 11.0732 7.71967 10.7803L6.71967 9.78033C6.42678 9.48744 6.42678 9.01256 6.71967 8.71967C7.01256 8.42678 7.48744 8.42678 7.78033 8.71967L8.25 9.18934L9.71967 7.71967C10.0126 7.42678 10.4874 7.42678 10.7803 7.71967Z" data-v-490f8cf8${_scopeId2}></path><path d="M10.7803 14.2803C11.0732 13.9874 11.0732 13.5126 10.7803 13.2197C10.4874 12.9268 10.0126 12.9268 9.71967 13.2197L8.25 14.6893L7.78033 14.2197C7.48744 13.9268 7.01256 13.9268 6.71967 14.2197C6.42678 14.5126 6.42678 14.9874 6.71967 15.2803L7.71967 16.2803C8.01256 16.5732 8.48744 16.5732 8.78033 16.2803L10.7803 14.2803Z" data-v-490f8cf8${_scopeId2}></path><path d="M5.25 3C4.00736 3 3 4.00736 3 5.25V18.75C3 19.9926 4.00736 21 5.25 21H18.75C19.9926 21 21 19.9926 21 18.75V5.25C21 4.00736 19.9926 3 18.75 3H5.25ZM4.5 5.25C4.5 4.83579 4.83579 4.5 5.25 4.5H18.75C19.1642 4.5 19.5 4.83579 19.5 5.25V18.75C19.5 19.1642 19.1642 19.5 18.75 19.5H5.25C4.83579 19.5 4.5 19.1642 4.5 18.75V5.25Z" data-v-490f8cf8${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          width: "25px",
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Задания"))}</p>`);
                    } else {
                      return [
        ...
        navTitleIcon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (!unref(loadCurrentUser).user.company_logo_url) {
              _push2(`<div class="dark:fill-white fill-black px-2" data-v-490f8cf8${_scopeId}><svg width="18" height="19" viewBox="0 0 18 19" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId}><path d="M9 12.7278V9.52783M9 6.32783H9.008M17 9.52783C17 13.9461 13.4182 17.5278 9 17.5278C4.58172 17.5278 1 13.9461 1 9.52783C1 5.10955 4.58172 1.52783 9 1.52783C13.4182 1.52783 17 5.10955 17 9.52783Z" stroke="black" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId}></path></svg></div>`);
            } else {
              _push2(`<div class="w-[40px] h-[40px]" data-v-490f8cf8${_scopeId}><img class="w-full rounded-full"${ssrRenderAttr("src", unref(loadCurrentUser).user.company_logo_url)} alt="" data-v-490f8cf8${_scopeId}></div>`);
            }
          } else {
            return [
          ...
          if (_push2) {
            if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("documents")) {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId2}><path stroke="currentColor" d="M5 8C5 5.17157 5 3.75736 5.87868 2.87868C6.75736 2 8.17157 2 11 2H13C15.8284 2 17.2426 2 18.1213 2.87868C19 3.75736 19 5.17157 19 8V16C19 18.8284 19 20.2426 18.1213 21.1213C17.2426 22 15.8284 22 13 22H11C8.17157 22 6.75736 22 5.87868 21.1213C5 20.2426 5 18.8284 5 16V8Z" stroke-width="1.5" data-v-490f8cf8${_scopeId2}></path><path stroke="currentColor" d="M5 4.07617C4.02491 4.17208 3.36857 4.38885 2.87868 4.87873C2 5.75741 2 7.17163 2 10.0001V14.0001C2 16.8285 2 18.2427 2.87868 19.1214C3.36857 19.6113 4.02491 19.828 5 19.9239" stroke-width="1.5" data-v-490f8cf8${_scopeId2}></path><path stroke="currentColor" d="M19 4.07617C19.9751 4.17208 20.6314 4.38885 21.1213 4.87873C22 5.75741 22 7.17163 22 10.0001V14.0001C22 16.8285 22 18.2427 21.1213 19.1214C20.6314 19.6113 19.9751 19.828 19 19.9239" stroke-width="1.5" data-v-490f8cf8${_scopeId2}></path><path stroke="currentColor" d="M9 13H15" stroke-width="1.5" stroke-linecap="round" data-v-490f8cf8${_scopeId2}></path><path stroke="currentColor" d="M9 9H15" stroke-width="1.5" stroke-linecap="round" data-v-490f8cf8${_scopeId2}></path><path stroke="currentColor" d="M9 17H12" stroke-width="1.5" stroke-linecap="round" data-v-490f8cf8${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        class: "dark:stroke-white stroke-black",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Документы"))}</p>`);
                  } else {
                    return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("sales")) {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Продажи"))}</p>`);
                  } else {
                    return [
              ...
              navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(loadCurrentUser).user.role === "Администратор сайта") {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Компании"))}</p>`);
                  } else {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Компания"))}</p>`);
                  }
                } else {
                  return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin") {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Департаменты"))}</p>`);
                  } else {
                    return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin") {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg width="25px" height="25px" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId2}><path stroke="currentColor" d="M23,9h6a2,2,0,0,0,2-2V3a2,2,0,0,0-2-2H23a2,2,0,0,0-2,2V4H11V3A2,2,0,0,0,9,1H3A2,2,0,0,0,1,3V7A2,2,0,0,0,3,9H9a2,2,0,0,0,2-2V6h4V26a2.0023,2.0023,0,0,0,2,2h4v1a2,2,0,0,0,2,2h6a2,2,0,0,0,2-2V25a2,2,0,0,0-2-2H23a2,2,0,0,0-2,2v1H17V17h4v1a2,2,0,0,0,2,2h6a2,2,0,0,0,2-2V14a2,2,0,0,0-2-2H23a2,2,0,0,0-2,2v1H17V6h4V7A2,2,0,0,0,23,9Zm0-6h6V7H23ZM9,7H3V3H9ZM23,25h6v4H23Zm0-11h6v4H23Z" transform="translate(0 0.0049)" data-v-490f8cf8${_scopeId2}></path><rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" fill="none" width="32" height="32" data-v-490f8cf8${_scopeId2}></rect></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        width: "25px",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Дерево"))}</p>`);
                  } else {
                    return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("objects")) {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId2}><path stroke="currentColor" d="M20.3873 7.1575L11.9999 12L3.60913 7.14978" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId2}></path><path stroke="currentColor" d="M12 12V21" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId2}></path><path stroke="currentColor" d="M11 2.57735C11.6188 2.22008 12.3812 2.22008 13 2.57735L19.6603 6.42265C20.2791 6.77992 20.6603 7.44017 20.6603 8.1547V15.8453C20.6603 16.5598 20.2791 17.2201 19.6603 17.5774L13 21.4226C12.3812 21.7799 11.6188 21.7799 11 21.4226L4.33975 17.5774C3.72094 17.2201 3.33975 16.5598 3.33975 15.8453V8.1547C3.33975 7.44017 3.72094 6.77992 4.33975 6.42265L11 2.57735Z" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        width: "25px",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Объекты"))}</p>`);
                  } else {
                    return [
            ...
            if (_push2) {
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("task.create")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Склад"))}</p>`);
                    } else {
                      return [
      ...
      if (((_i = (_h = (_g = unref(loadCurrentUser)) == null ? void 0 : _g.user) == null ? void 0 : _h.role) == null ? void 0 : _i.name_en) !== "admin" && (isValidLink("chat") || isValidLink("file_manager"))) {
        _push(ssrRenderComponent(_sfc_main$2, null, {
          ...
          navTitleIcon: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div class="dark:fill-white fill-black ml-1.5" data-v-490f8cf8${_scopeId}><svg width="24" height="25" viewBox="0 0 24 25" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId}><path d="M12 13.5278C12.5523 13.5278 13 13.0801 13 12.5278C13 11.9755 12.5523 11.5278 12 11.5278C11.4477 11.5278 11 11.9755 11 12.5278C11 13.0801 11.4477 13.5278 12 13.5278Z" fill="black" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId}></path><path d="M19 13.5278C19.5523 13.5278 20 13.0801 20 12.5278C20 11.9755 19.5523 11.5278 19 11.5278C18.4477 11.5278 18 11.9755 18 12.5278C18 13.0801 18.4477 13.5278 19 13.5278Z" fill="black" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId}></path><path d="M5 13.5278C5.55228 13.5278 6 13.0801 6 12.5278C6 11.9755 5.55228 11.5278 5 11.5278C4.44772 11.5278 4 11.9755 4 12.5278C4 13.0801 4.44772 13.5278 5 13.5278Z" fill="black" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId}></path></svg></div>`);
            } else {
              return [
            ...
            if (_push2) {
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("chat")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg width="25px" height="25px" class="dark:stroke-white stroke-black" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000" data-v-490f8cf8${_scopeId2}><line x1="16" y1="20" x2="48" y2="20" stroke-width="2" data-v-490f8cf8${_scopeId2}></line><line x1="16" y1="30" x2="48" y2="30" stroke-width="2" data-v-490f8cf8${_scopeId2}></line><line x1="16" y1="40" x2="48" y2="40" stroke-width="2" data-v-490f8cf8${_scopeId2}></line><path d="m56 56-12-4H17.16A9.16 9.16 0 0 1 8 42.84V17.16A9.16 9.16 0 0 1 17.16 8h29.68A9.16 9.16 0 0 1 56 17.16z" stroke-width="2" data-v-490f8cf8${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          width: "25px",
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Чат"))}</p>`);
                    } else {
                      return [
              ...
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("file_manager")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-490f8cf8${_scopeId2}>${ssrInterpolate(_ctx.$t("Облако"))}</p>`);
                    } else {
                      return [
      ...
      _push(`<div class="h-full transition-all duration-500 mx-auto max-md:!ml-3" data-v-490f8cf8>`);
      _push(ssrRenderComponent(_sfc_main$a, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="w-10 h-10 rounded-lg border flex items-center justify-center" data-v-490f8cf8${_scopeId}><svg width="18" height="16" viewBox="0 0 18 16" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-490f8cf8${_scopeId}><path d="M4.2 4.7998L1 7.9998M1 7.9998L4.2 11.1998M1 7.9998H11.4M6.6 1.76304C7.61984 1.15042 8.80384 0.799805 10.0666 0.799805C13.8958 0.799805 17 4.02336 17 7.9998C17 11.9763 13.8958 15.1998 10.0666 15.1998C8.80384 15.1998 7.61984 14.8492 6.6 14.2366" stroke="#2A2A2A" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round" data-v-490f8cf8${_scopeId}></path></svg></div>`);
            if (unref(loadCurrentUser).activeNav) {
              _push2(`<p class="font-medium text-sm dark:text-white text-black" data-v-490f8cf8${_scopeId}>${ssrInterpolate(_ctx.$t("Выйти"))}</p>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const TheNavigation = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-490f8cf8"]]);
...
//# sourceMappingURL=base-Q76mFuH-.js.map
