...
import { useSSRContext, defineComponent, ref, watch, onUpdated, mergeProps, unref, withCtx, createVNode, toDisplayString, openBlock, createBlock, createCommentVNode, createTextVNode, isRef, resolveComponent, Fragment, renderList } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrRenderStyle, ssrRenderSlot } from 'vue/server-renderer';
import { T as TheContentBlock } from './TheContentBlock-CceRERsm.mjs';
import { _ as __nuxt_component_0$2 } from './ContextMenu-nHXVbC_w.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-link-CNB8XBKy.mjs';
import { u as useStorageStore } from './storage-hzmmv_jF.mjs';
import { useRoute, useRouter as useRouter$1 } from 'vue-router';
import { _ as _sfc_main$9 } from './TheModal-CnBva0fQ.mjs';
import { _ as _sfc_main$c } from './TheButton-Bz9xS3BF.mjs';
import { _ as _sfc_main$b } from './TheTextContent-0-tZhPDG.mjs';
import { _ as _sfc_main$e } from './TheSearch-Dw2_cWOE.mjs';
import { v as viewSelect, h as handleSearch, _ as __nuxt_component_2 } from './SelectMenu-C0_HeS3D.mjs';
import { _ as _sfc_main$d } from './TheInput-BfTT2E6G.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as __nuxt_component_0$3 } from './Tooltip-DGOs9ivX.mjs';
import { _ as __nuxt_component_3 } from './Icon-jARSlWRz.mjs';
import { _ as _sfc_main$f } from './StorageCard-DD-rRX-H.mjs';
import { QrcodeStream } from 'vue-qrcode-reader';
import { _ as _sfc_main$a } from './TheBreadcrumbs-BV4tnjik.mjs';
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      const _component_UContextMenu = __nuxt_component_0$2;
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UTooltip, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<button type="button" class="${ssrRenderClass([{ "dark:border-gray-200 border-gray-400": __props.mode === "scan" }, "relative border dark:border-gray-400 rounded-lg p-1 transition-all"])}" data-v-d2e7296b${_scopeId}><svg class="" width="30px" height="30px" viewBox="0 -0.5 17 17" version="1.1" xmlns="http://www.w3.org/2000/svg" data-v-d2e7296b${_scopeId}><g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd" data-v-d2e7296b${_scopeId}><g transform="translate(1.000000, 2.000000)" class="${ssrRenderClass([{ "dark:!fill-gray-200 fill-gray-500": __props.mode === "scan" }, "dark:fill-gray-400 fill-gray-400"])}" data-v-d2e7296b${_scopeId}><rect x="13" y="0" width="1.953" height="10.914" class="si-glyph-fill" data-v-d2e7296b${_scopeId}></rect><rect x="10" y="0" width="1.967" height="10.914" class="si-glyph-fill" data-v-d2e7296b${_scopeId}></rect><rect x="8" y="0" width="0.95" height="10.914" class="si-glyph-fill" data-v-d2e7296b${_scopeId}></rect><rect x="4" y="0" width="1.972" height="10.914" class="si-glyph-fill" data-v-d2e7296b${_scopeId}></rect><rect x="2" y="0" width="0.973" height="10.914" class="si-glyph-fill" data-v-d2e7296b${_scopeId}></rect><rect x="0" y="0" width="0.973" height="10.914" class="si-glyph-fill" data-v-d2e7296b${_scopeId}></rect></g></g></svg><div class="${ssrRenderClass([{ "laser": __props.mode === "scan" }, "w-[39px] h-[1.2px] rounded-full shadow shadow-cyan dark:shadow-semiCyan dark:bg-semiCyan bg-blueSemiLight absolute top-4 left-0"])}" data-v-d2e7296b${_scopeId}></div></button>`);
          } else {
            return [
              createVNode("button", {
                type: "button",
...
const ScanAnimation = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-d2e7296b"]]);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    watch(() => company.company, (newValue) => {
      var _a;
      let permission = (_a = company.company.modules) == null ? void 0 : _a.find((item) => item.name_en === "task.create");
      if (!permission) {
        if ((void 0).history.length > 1) {
          router.push("/base/profile");
        } else {
            ...
            return [
              createVNode("div", { class: "flex justify-between items-center" }, [
                createVNode("div", { class: "flex items-center gap-x-4 mb-4" }, [
                  ...
                  unref(route).path === `/base/storage/${unref(route).params.slug}` || unref(route).path === `/base/storage/${unref(route).params.slug}/${unref(route).params.nestedSlug}` ? (openBlock(), createBlock(_sfc_main$a, {
                    key: 1,
                    "breadcrumb-link": unref(route).path === `/base/storage/${unref(route).params.slug}/${unref(route).params.nestedSlug}` ? `/base/storage/${unref(route).params.slug}` : ""
                  }, {
                    default: withCtx(() => [
                  ...
                  unref(route).path === `/base/storage/${unref(route).params.slug}/${unref(route).params.nestedSlug}` ? (openBlock(), createBlock(_sfc_main$a, { key: 3 }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(unref(route).params.nestedSlug), 1)
                    ]),
                    _: 1
...
//# sourceMappingURL=storage-XC4c04Vv.mjs.map
