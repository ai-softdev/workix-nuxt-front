...
import { _ as _imports_0$1, a as _imports_5 } from './profile-sfkvonJq.mjs';
...
import { _ as _sfc_main$6 } from './TheModal-CjGVpCB-.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full col-span-2 p-6 bg-white dark:border-t dark:border-t-gray-500 dark:shadow-md shadow-profileCard dark:shadow-gray-500 rounded-3xl hover:transform hover:-translate-y-2 transition-all duration-200"><div class="border rounded-full px-3 py-2 w-fit flex items-center gap-3 mb-8"><img${ssrRenderAttr("src", _imports_5)} alt="statistic"><h2 class="dark:text-white">${ssrInterpolate(_ctx.$t("\u041B\u0438\u0447\u043D\u0430\u044F \u0441\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430"))}</h2></div>`);
      _push(ssrRenderComponent(_sfc_main$5, null, null, _parent));
      _push(`</div></div><div class="grid grid-cols-3 max-[1150px]:!grid-cols-1 gap-x-5 mt-5">`);
      _push(ssrRenderComponent(TheContentBlock, { class: "bg-white shadow-profileCard hover:transform hover:-translate-y-2 transition-all duration-200" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=profile-BTM2HlPW.mjs.map
