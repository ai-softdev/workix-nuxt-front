...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./base-D9SG4SPU.mjs').then((m) => m.default || m),
    children: [
      {
        name: "base-chat",
        path: "chat",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./chat-D3PhFCNn.mjs').then((m) => m.default || m),
        children: [
          {
            name: "base-chat-id",
            path: ":id()",
            ...
            alias: [],
            redirect: void 0 ,
            component: () => import('./_id_-Bp9dQ4fD.mjs').then((m) => m.default || m)
          }
        ]
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-Dj46zpfG.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_id_-D2YO7QId.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_id_-BlmuvLi6.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-e92BFkuF.mjs').then((m) => m.default || m)
      },
      {
        name: "base-companies",
        path: "companies",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-NLXMVSbL.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_id_-C_yPNB1j.mjs').then((m) => m.default || m)
      },
      {
      ...
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_slug_-B9qXgWJo.mjs').then((m) => m.default || m)
      },
      {
        name: "base-documents",
        path: "documents",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-DxBuXt-a.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_slug_-JEsed2aW.mjs').then((m) => m.default || m)
      },
      {
        name: "base-graph",
        path: "graph",
      ...
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_id_-Cs_f4F0-.mjs').then((m) => m.default || m)
      },
      {
        name: "base-objects",
        path: "objects",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-yqdIFBRO.mjs').then((m) => m.default || m)
      },
      {
        name: "base-profile",
        path: "profile",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./profile-C9xsdshe.mjs').then((m) => m.default || m)
      },
      {
        name: "base-sales",
        path: "sales",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-CpMpewa6.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-B-ua7KVh.mjs').then((m) => m.default || m)
      },
      {
        name: "base-storage",
        path: "storage",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./storage-D_Zfa3nm.mjs').then((m) => m.default || m),
        children: [
          {
            ...
            alias: [],
            redirect: void 0 ,
            component: () => import('./index-DNs-dcGm.mjs').then((m) => m.default || m)
          },
          {
            ...
            alias: [],
            redirect: void 0 ,
            component: () => import('./index-CzLi76xU.mjs').then((m) => m.default || m)
          }
        ]
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_id_-Dz1kHrAS.mjs').then((m) => m.default || m)
      },
      {
        name: "base-tasks",
        path: "tasks",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-BinhlOud.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./exam-Dq6jtQIK.mjs').then((m) => m.default || m)
      },
      {
        name: "base-tests",
        path: "tests",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-CLryhgBL.mjs').then((m) => m.default || m)
      },
      {
        name: "base-tree",
        path: "tree",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-BZ2CtfPh.mjs').then((m) => m.default || m)
      },
      {
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./_slug_-B-BtushG.mjs').then((m) => m.default || m)
      },
      {
        name: "base-users",
        path: "users",
        ...
        alias: [],
        redirect: void 0 ,
        component: () => import('./index-CQFbLnm2.mjs').then((m) => m.default || m)
      }
    ]
  },
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-M4M13Jcn.mjs').then((m) => m.default || m)
  }
];
...
const namedMiddleware = {
  authorized: () => import('./authorized-B2KR22B2.mjs')
};
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-CEQu5tsF.mjs').then((r) => r.default));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-Oh054k0U.mjs').then((r) => r.default));
...
export { onClickOutside as A, useAppConfig as B, useNuxtApp as C, useDebounceFn as D, computedAsync as E, useMediaQuery as F, useParallax as G, useRoute as H, defineNuxtRouteMiddleware as I, useRequestHeader as J, __nuxt_component_0 as _, useRouter as a, parseQuery as b, createError as c, useRuntimeConfig as d, entry$1 as default, navigateTo as e, withoutTrailingSlash as f, useState as g, hasProtocol as h, defineStore as i, joinURL as j, useSeoMeta as k, __nuxt_component_0$1 as l, directiveHooks as m, nuxtLinkDefaults as n, notNullish as o, parseURL as p, noop as q, tryOnScopeDispose as r, toRef as s, toValue as t, useHead as u, useMouse as v, withTrailingSlash as w, useWindowScroll as x, mergeConfig as y, appConfig as z };
