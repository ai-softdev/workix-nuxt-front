...
import { u as useTreeStore, _ as _sfc_main$4 } from './TheButton-RleONNaZ.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a, _b, _c, _d, _e;
      _push(`<div${ssrRenderAttrs(_attrs)} data-v-12ca9de9><div class="${ssrRenderClass([{ "z-[101] fixed": unref(treeStore).treeFullScreen === true }, "hidden max-md:flex max-md:justify-center select-none gap-x-2 top-10 right-10 z-10"])}" data-v-12ca9de9>`);
      _push(ssrRenderComponent(TheTreeButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="stroke-white" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-12ca9de9${_scopeId}><path d="M9.99999 20.9585C6.88841 20.8286 4.41431 20.4143 4.00001 20C3.5857 19.5857 3.17139 17.1116 3.04155 14M20.9585 14C20.8286 17.1116 20.4143 19.5857 20 20C19.5857 20.4143 17.1116 20.8286 14 20.9585M14 3.04155C17.1116 3.17139 19.5857 3.5857 20 4.00001C20.4143 4.41431 20.8286 6.88842 20.9585 10M10 3.04155C6.88842 3.17139 4.41431 3.5857 4.00001 4.00001C3.5857 4.41431 3.17139 6.88842 3.04155 10" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-12ca9de9${_scopeId}></path></svg>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(TheTreeButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="fill-white" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-12ca9de9${_scopeId}><path fill-rule="evenodd" clip-rule="evenodd" d="M5 10C5 7.23858 7.23858 5 10 5C12.7614 5 15 7.23858 15 10C15 11.381 14.4415 12.6296 13.5355 13.5355C12.6296 14.4415 11.381 15 10 15C7.23858 15 5 12.7614 5 10ZM10 3C6.13401 3 3 6.13401 3 10C3 13.866 6.13401 17 10 17C11.5719 17 13.0239 16.481 14.1921 15.6063L19.2929 20.7071C19.6834 21.0976 20.3166 21.0976 20.7071 20.7071C21.0976 20.3166 21.0976 19.6834 20.7071 19.2929L15.6063 14.1921C16.481 13.0239 17 11.5719 17 10C17 6.13401 13.866 3 10 3ZM11 8C11 7.44772 10.5523 7 10 7C9.44772 7 9 7.44772 9 8V9H8C7.44772 9 7 9.44772 7 10C7 10.5523 7.44772 11 8 11H9V12C9 12.5523 9.44772 13 10 13C10.5523 13 11 12.5523 11 12V11H12C12.5523 11 13 10.5523 13 10C13 9.44772 12.5523 9 12 9H11V8Z" data-v-12ca9de9${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "fill-white",
      ...
      _push(ssrRenderComponent(TheTreeButton, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg class="fill-white" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-12ca9de9${_scopeId}><path fill-rule="evenodd" clip-rule="evenodd" d="M5 10C5 7.23858 7.23858 5 10 5C12.7614 5 15 7.23858 15 10C15 11.381 14.4415 12.6296 13.5355 13.5355C12.6296 14.4415 11.381 15 10 15C7.23858 15 5 12.7614 5 10ZM10 3C6.13401 3 3 6.13401 3 10C3 13.866 6.13401 17 10 17C11.5719 17 13.0239 16.481 14.1921 15.6063L19.2929 20.7071C19.6834 21.0976 20.3166 21.0976 20.7071 20.7071C21.0976 20.3166 21.0976 19.6834 20.7071 19.2929L15.6063 14.1921C16.481 13.0239 17 11.5719 17 10C17 6.13401 13.866 3 10 3ZM8 9C7.44772 9 7 9.44772 7 10C7 10.5523 7.44772 11 8 11H12C12.5523 11 13 10.5523 13 10C13 9.44772 12.5523 9 12 9H8Z" data-v-12ca9de9${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                class: "fill-white",
      ...
      _push(ssrRenderComponent(unref(VueTree), {
        ...
        node: withCtx(({ node, collapsed }, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            _push2(`<div class="${ssrRenderClass([{ "shadow-md dark:shadow-gray-400 ": node.id === ((_a2 = unref(treeUserInfo)) == null ? void 0 : _a2.id) }, "p-2 bg-blueDarkSemiLight transition-all rounded-lg"])}" data-v-12ca9de9${_scopeId}><img alt="photo"${ssrRenderAttr("src", node.photo)} class="w-[50px] h-[50px] rounded-full mx-auto" data-v-12ca9de9${_scopeId}><p class="text-white text-center break-words" style="${ssrRenderStyle({ "font-weight": "bold" })}" data-v-12ca9de9${_scopeId}>${ssrInterpolate(node.name)}</p><p class="text-white text-center break-words" style="${ssrRenderStyle({ "font-weight": "bold" })}" data-v-12ca9de9${_scopeId}>${ssrInterpolate(((_b2 = node.first_name) == null ? void 0 : _b2.length) > 10 && ((_c2 = node.last_name) == null ? void 0 : _c2.length) > 10 ? node.first_name + " " + node.last_name.slice(0, 9) + "..." : node.first_name + " " + node.last_name)}</p><p class="text-sm text-white text-center" data-v-12ca9de9${_scopeId}>${ssrInterpolate(node.position)}</p></div>`);
          } else {
            return [
              createVNode("div", {
      ...
      _push(`<div class="absolute max-md:hidden flex select-none gap-x-2 top-10 right-10 z-10" data-v-12ca9de9>`);
      _push(ssrRenderComponent(TheTreeButton, {
        onClick: ($event) => unref(treeStore).treeFullScreen = !unref(treeStore).treeFullScreen
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(`</div><div class="${ssrRenderClass([{ "!rounded-none dark:!bg-gray-700": unref(treeStore).treeFullScreen, "!w-0 ": !unref(treeUserInfo), "!w-[25%] dark:border-r-gray-400 border-r ": unref(treeUserInfo) }, "absolute left-0 top-0 rounded-tl-2xl rounded-bl-2xl dark:bg-gray-700 bg-white z-50 h-full transition-all duration-200"])}" data-v-12ca9de9>`);
      if (unref(treeUserInfo)) {
        _push(`<div class="relative" data-v-12ca9de9><button class="${ssrRenderClass([{ "fixed !top-1 !p-[3px]": unref(treeStore).treeFullScreen }, "absolute top-2 right-0 p-1 border-t border-l border-b"])}" data-v-12ca9de9><svg class="dark:stroke-white stroke-black" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-12ca9de9><path d="M10 7L15 12L10 17" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-12ca9de9></path></svg></button><div class="mx-auto mt-4 gap-y-2 px-2 flex flex-col justify-center items-center" data-v-12ca9de9><img class="w-[70px] h-[70px] rounded-full mt-10 dark:border-none border"${ssrRenderAttr("src", unref(authStore).get_server_domain + ((_a = unref(treeUserInfo)) == null ? void 0 : _a.photo_url))} alt="" data-v-12ca9de9><div class="dark:text-white text-black text-center" data-v-12ca9de9><p class="text-xl break-words" data-v-12ca9de9>${ssrInterpolate(((_b = unref(treeUserInfo)) == null ? void 0 : _b.first_name) + " " + ((_c = unref(treeUserInfo)) == null ? void 0 : _c.last_name))}</p><p class="text-sm" data-v-12ca9de9>${ssrInterpolate((_d = unref(treeUserInfo)) == null ? void 0 : _d.position)}</p></div><div data-v-12ca9de9><p class="break-words text-center" data-v-12ca9de9>${ssrInterpolate(_ctx.$t("\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442:"))} <span data-v-12ca9de9>${ssrInterpolate((_e = unref(treeUserInfo)) == null ? void 0 : _e.department)}</span></p></div></div><div class="px-2 my-6 flex flex-wrap justify-center gap-2" data-v-12ca9de9>`);
...
const TreeContent = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-12ca9de9"]]);
const _sfc_main = {
  __name: "index",
  __ssrInlineRender: true,
  props: {
...
//# sourceMappingURL=index-b4Zoa0YT.mjs.map
