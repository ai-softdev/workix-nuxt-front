...
import { _ as _sfc_main$3 } from './TheButton-RleONNaZ.mjs';
import { _ as _sfc_main$4 } from './TheModal-DcnSgpbI.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div><div class="flex items-center justify-between"><p class="text-sm dark:text-gray-400">${ssrInterpolate(_ctx.$t("\u0417\u0430\u043C\u0435\u0441\u0442\u0438\u0442\u0435\u043B\u044C"))}</p>`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex items-center justify-between"><p class="dark:text-white text-3xl font-bold mb-6">${ssrInterpolate(_ctx.$t("\u0421\u0442\u0440\u0430\u043D\u0438\u0446\u0430 \u0434\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442\u043E\u0432 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0438"))}</p>`);
      _push(ssrRenderComponent(_sfc_main$1, { class: "w-3/12 max-md:w-9/12 max-md:mb-4 text-sm" }, null, _parent));
      _push(`</div><div class="flex relative items-center justify-between w-full gap-x-10 mt-4"><p class="text-mediumGray w-6/12">${ssrInterpolate(_ctx.$t("\u041A\u043B\u0438\u043A\u043D\u0438\u0442\u0435 \u043D\u0430 \u043E\u0442\u0434\u0435\u043B, \u0447\u0442\u043E\u0431\u044B \u043F\u043E\u0441\u043C\u043E\u0442\u0440\u0435\u0442\u044C \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u044B\u0435 \u0434\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u0438."))}</p></div><div class="mt-8">`);
...
//# sourceMappingURL=index-BeVOflM0.mjs.map
