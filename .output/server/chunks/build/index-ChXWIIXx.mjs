...
import { u as useDocumentStore } from './documents-BF8hPVoH.mjs';
...
import { _ as _sfc_main$b } from './TheFileInput-D9GEg0tC.mjs';
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const documentStore = useDocumentStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full h-fit bg-white px-5 py-6 rounded-3xl shadow-cards" }, _attrs))}><div class="w-full p-2 flex items-center gap-2 justify-center border rounded-full mb-8"><img${ssrRenderAttr("src", _imports_6)} alt="info"><p>${ssrInterpolate(_ctx.$t("\u0418\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F"))}</p></div><div class="flex flex-col gap-y-4">`);
...
//# sourceMappingURL=index-ChXWIIXx.mjs.map
