...
import { v as viewSelect, u as uploadFile, _ as __nuxt_component_2 } from './SelectMenu-C0_HeS3D.mjs';
...
import { _ as _sfc_main$8 } from './TheModal-CnBva0fQ.mjs';
import { _ as _sfc_main$a } from './TheInput-BfTT2E6G.mjs';
import { _ as _sfc_main$b } from './TheButton-DDcCSWqY.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UContextMenu, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="" data-v-eeedfca8${_scopeId}><div class="dark:hover:bg-gray-500 hover:bg-gray-200 p-2 cursor-pointer flex items-center gap-x-10" data-v-eeedfca8${_scopeId}><div data-v-eeedfca8${_scopeId}><svg class="stroke-black dark:stroke-white" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-eeedfca8${_scopeId}><path d="M21.2799 6.40005L11.7399 15.94C10.7899 16.89 7.96987 17.33 7.33987 16.7C6.70987 16.07 7.13987 13.25 8.08987 12.3L17.6399 2.75002C17.8754 2.49308 18.1605 2.28654 18.4781 2.14284C18.7956 1.99914 19.139 1.92124 19.4875 1.9139C19.8359 1.90657 20.1823 1.96991 20.5056 2.10012C20.8289 2.23033 21.1225 2.42473 21.3686 2.67153C21.6147 2.91833 21.8083 3.21243 21.9376 3.53609C22.0669 3.85976 22.1294 4.20626 22.1211 4.55471C22.1128 4.90316 22.0339 5.24635 21.8894 5.5635C21.7448 5.88065 21.5375 6.16524 21.2799 6.40005V6.40005Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path><path d="M11 4H6C4.93913 4 3.92178 4.42142 3.17163 5.17157C2.42149 5.92172 2 6.93913 2 8V18C2 19.0609 2.42149 20.0783 3.17163 20.8284C3.92178 21.5786 4.93913 22 6 22H17C19.21 22 20 20.2 20 18V13" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path></svg></div><p data-v-eeedfca8${_scopeId}>${ssrInterpolate(_ctx.$t("\u041F\u0435\u0440\u0435\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u0442\u044C"))}</p></div><div class="dark:hover:bg-gray-500 hover:bg-gray-200 p-2 cursor-pointer flex items-center gap-x-10" data-v-eeedfca8${_scopeId}><div data-v-eeedfca8${_scopeId}><svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-eeedfca8${_scopeId}><path data-v-965c8b16="" d="M12 11L12 16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path><path data-v-965c8b16="" d="M14.5 13.5L9.5 13.5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path><path data-v-965c8b16="" d="M3 9.312C3 4.93757 3.93757 4 8.312 4H9.92963C10.5983 4 11.2228 4.3342 11.5937 4.8906L12.4063 6.1094C12.7772 6.6658 13.4017 7 14.0704 7C15.9647 7 17.8145 7 19.1258 7C20.1807 7 21.0128 7.82095 21.0029 8.8758C21.0013 9.05376 21 9.20638 21 9.312V14.688C21 19.0624 20.0624 20 15.688 20H8.312C3.93757 20 3 19.0624 3 14.688V9.312Z" stroke-width="2" data-v-eeedfca8${_scopeId}></path></svg></div><p data-v-eeedfca8${_scopeId}>${ssrInterpolate(_ctx.$t("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043F\u0430\u043F\u043A\u0443"))}</p></div><div class="dark:hover:bg-gray-500 hover:bg-gray-200 p-2 cursor-pointer flex items-center gap-x-10" data-v-eeedfca8${_scopeId}><div data-v-eeedfca8${_scopeId}><svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-eeedfca8${_scopeId}><path d="M10 12V17" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path><path d="M14 12V17" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path><path d="M4 7H20" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path><path d="M6 10V18C6 19.6569 7.34315 21 9 21H15C16.6569 21 18 19.6569 18 18V10" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path><path d="M9 5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5V7H9V5Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8${_scopeId}></path></svg></div><p data-v-eeedfca8${_scopeId}>${ssrInterpolate(_ctx.$t("\u0423\u0431\u0440\u0430\u0442\u044C \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(`<div class="max-[840px]:!bg-white max-[840px]:shadow max-[840px]:p-6 max-[840px]:w-[320px] max-[400px]:w-[280px]" data-v-eeedfca8><div data-v-eeedfca8><div class="${ssrRenderClass([{ "max-[840px]:hidden": __props.activeStructure === false }, "absolute w-10 h-10 shadow cursor-pointer border rounded-3xl px-2 bg-white hidden max-[840px]:block right-5 top-0"])}" data-v-eeedfca8><svg class="mt-2" width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-eeedfca8><path d="M16.9995 15.9995L20.9995 11.9995M20.9995 11.9995L16.9995 7.99951M20.9995 11.9995H8.99951M12.9995 20.9995H6.20029C5.08019 20.9995 4.52014 20.9995 4.09231 20.7815C3.71599 20.5898 3.41003 20.2838 3.21828 19.9075C3.00029 19.4797 3.00029 18.9196 3.00029 17.7995V6.19951C3.00029 5.07941 3.00029 4.51935 3.21828 4.09153C3.41003 3.71521 3.71599 3.40925 4.09231 3.2175C4.52014 2.99951 5.08019 2.99951 6.20029 2.99951L12.9995 2.99951" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-eeedfca8></path></svg></div></div><button class="${ssrRenderClass([{ "max-[840px]:hidden": !__props.activeStructure }, "w-full flex cursor-pointer p-2 bg-golden rounded-full font-bold dark:hover:bg-gray-500 transition-all duration-200 items-center gap-x-4 my-4 justify-center mx-auto"])}" data-v-eeedfca8> + ${ssrInterpolate(_ctx.$t("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043F\u0430\u043F\u043A\u0443"))}</button>`);
        ...
        _push(ssrRenderComponent(_sfc_main$8, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<form data-v-eeedfca8${_scopeId}><div class="flex items-center justify-center gap-x-10 my-10" data-v-eeedfca8${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$a, {
                class: "w-6/12",
              ...
              _push2(`<div class="w-6/12 flex flex-col gap-y-2" data-v-eeedfca8${_scopeId}><p class="tracking-widest dark:text-white" data-v-eeedfca8${_scopeId}>${ssrInterpolate(_ctx.$t("\u0420\u0430\u0441\u043F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u043F\u0430\u043F\u043A\u0438"))}</p><select class="w-full p-2.5 rounded-md dark:bg-gray-300" data-v-eeedfca8${_scopeId}><option value="" data-v-eeedfca8${_scopeId}>${ssrInterpolate(_ctx.$t("\u041D\u0430\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u043D\u0438\u0435"))}</option></select></div></div><div class="flex justify-center gap-x-10" data-v-eeedfca8${_scopeId}>`);
              _push2(ssrRenderComponent(_sfc_main$b, {
      ...
      _push(`<div class="${ssrRenderClass({ "max-[840px]:hidden": !__props.activeStructure })}" data-v-eeedfca8><div data-v-eeedfca8>`);
      _push(ssrRenderComponent(TheCloudUIStructureFolder, null, {
        ...
        structureSvg: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_0)} alt="recent" data-v-eeedfca8${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_0,
      ...
      _push(ssrRenderComponent(TheCloudUIStructureFolder, null, {
        ...
        structureSvg: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<img${ssrRenderAttr("src", _imports_1)} alt="favourite" data-v-eeedfca8${_scopeId}>`);
          } else {
            return [
              createVNode("img", {
                src: _imports_1,
...
const TheCloudUiStructure = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-eeedfca8"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex w-full gap-x-10 h-full relative rounded-3xl bg-white shadow-cards mt-8 p-6" }, _attrs))}><div class="${ssrRenderClass([{ "!hidden": !__props.activeStructure }, "absolute top-0 right-0 w-full z-[22] hidden max-[840px]:block"])}"></div><div class="w-2/12 max-[1300px]:w-3/12 max-[840px]:absolute max-[840px]:bg-white"><p class="font-bold text-xl mb-5 max-[840px]:hidden"> \u0424\u0430\u0439\u043B\u044B \u0438 \u043F\u0430\u043F\u043A\u0438 </p><div class="${ssrRenderClass([{ "max-[425px]:w-full": __props.activeStructure }, "flex bg-porcelain shrink-0 border p-4 rounded-3xl flex-col h-full max-[840px]:border-none max-[840px]:absolute max-[840px]:z-40 max-[840px]:dark:bg-gray-600 max-[840px]:bg-white gap-y-10 !z-[23]"])}">`);
...
//# sourceMappingURL=index-zk-3MG_Q.mjs.map
