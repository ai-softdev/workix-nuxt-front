import { i as defineStore, a as useRouter, k as useSeoMeta, v as useMouse, x as useWindowScroll } from './server.mjs';
...
import { _ as __nuxt_component_0 } from './ContextMenu-BSTnVXjW.mjs';
import { v as viewSelect, u as uploadFile, _ as __nuxt_component_2 } from './SelectMenu-CmmfL4fq.mjs';
import { _ as __nuxt_component_3 } from './Icon-Bn6Kpv9I.mjs';
...
import { _ as _sfc_main$9 } from './TheTextContent-Bd9flYOl.mjs';
import { _ as _sfc_main$8 } from './TheModal-DtMcuqX0.mjs';
import { _ as _sfc_main$a } from './TheInput-BhoKAMvc.mjs';
import { _ as _sfc_main$b } from './TheButton-CWTlbPGF.mjs';
...
import 'animejs';
import './selectMenu-nIh9XKQv.mjs';
import '@tanstack/vue-virtual';
import './Icon-CEQu5tsF.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full" }, _attrs))} data-v-4a4f30c6><div class="absolute w-full h-full z-0 left-0 top-0" data-v-4a4f30c6></div>`);
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$5, {
              ...
              ContextMenuSvg: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg data-v-965c8b16="" class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId2}><path data-v-965c8b16="" d="M12 11L12 16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path><path data-v-965c8b16="" d="M14.5 13.5L9.5 13.5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path><path data-v-965c8b16="" d="M3 9.312C3 4.93757 3.93757 4 8.312 4H9.92963C10.5983 4 11.2228 4.3342 11.5937 4.8906L12.4063 6.1094C12.7772 6.6658 13.4017 7 14.0704 7C15.9647 7 17.8145 7 19.1258 7C20.1807 7 21.0128 7.82095 21.0029 8.8758C21.0013 9.05376 21 9.20638 21 9.312V14.688C21 19.0624 20.0624 20 15.688 20H8.312C3.93757 20 3 19.0624 3 14.688V9.312Z" stroke-width="2" data-v-4a4f30c6${_scopeId2}></path></svg>`);
                } else {
                  return [
            ...
            _push2(ssrRenderComponent(_sfc_main$5, {
              ...
              ContextMenuSvg: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId2}><path d="M8 16L12 12M12 12L16 16M12 12V21M20 16.7428C21.2215 15.734 22 14.2079 22 12.5C22 9.46243 19.5376 7 16.5 7C16.2815 7 16.0771 6.886 15.9661 6.69774C14.6621 4.48484 12.2544 3 9.5 3C5.35786 3 2 6.35786 2 10.5C2 12.5661 2.83545 14.4371 4.18695 15.7935" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "dark:stroke-white stroke-black",
              ...
              ContextMenuText: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<span data-v-4a4f30c6${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0417\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0444\u0430\u0439\u043B\u044B"))}</span>`);
                } else {
                  return [
              ...
              ContextMenuContent: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<input id="uploadCloudFiles" class="hidden" type="file" multiple data-v-4a4f30c6${_scopeId2}>`);
                } else {
                  return [
                    createVNode("input", {
      ...
      _push(`<div class="my-10 w-full h-full" data-v-4a4f30c6><div class="flex max-[500px]:flex-col justify-between items-center" data-v-4a4f30c6><h2 class="text-lg dark:text-white tracking-widest mb-6" data-v-4a4f30c6>${ssrInterpolate(_ctx.$t("\u0424\u0430\u0439\u043B\u044B \u0438 \u043F\u0430\u043F\u043A\u0438"))}</h2><div data-v-4a4f30c6>`);
      ...
      if (unref(cloudStore).showObjectElem && ((_a = __props.elemObject) == null ? void 0 : _a.id) !== ((_b = unref(cloudStore).get_all_folders) == null ? void 0 : _b.id)) {
        _push(`<div class="relative z-[20] w-7/12 flex justify-center mx-auto px-4 py-3 h-[50px] border rounded-lg text-center" data-v-4a4f30c6><p class="tracking-widest w-full" data-v-4a4f30c6>${ssrInterpolate(_ctx.$t("\u041D\u0430\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u043D\u0438\u0435") + ": " + ((_c = __props.elemObject) == null ? void 0 : _c.name))}</p><div class="flex gap-x-10" data-v-4a4f30c6><button type="button" class="px-4 tracking-wider bg-blueSemiLight rounded-full" data-v-4a4f30c6>${ssrInterpolate(_ctx.$t("\u041E\u0442\u043C\u0435\u043D\u0430"))}</button><button type="button" class="px-4 tracking-wider bg-blueSemiLight rounded-full" data-v-4a4f30c6>${ssrInterpolate(_ctx.$t("\u041F\u0435\u0440\u0435\u043C\u0435\u0441\u0442\u0438\u0442\u044C"))}</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="relative flex items-center max-md:justify-center max-md:mt-6 gap-x-2 overflow-hidden" data-v-4a4f30c6><button data-v-4a4f30c6><span class="text-sm tracking-widest" data-v-4a4f30c6>${ssrInterpolate(_ctx.$t("\u0413\u043B\u0430\u0432\u043D\u0430\u044F"))}</span></button>`);
      if (unref(cloudStore).get_folder.parent_id !== null) {
        _push(`<div data-v-4a4f30c6><svg class="dark:fill-gray-400 fill-black" width="20px" height="20px" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" data-v-inspector="pages/base/chat/[id].vue:25:11" data-v-4a4f30c6><path d="M604.7 759.2l61.8-61.8L481.1 512l185.4-185.4-61.8-61.8L357.5 512z" data-v-inspector="pages/base/chat/[id].vue:25:140" data-v-4a4f30c6></path></svg></div>`);
      } else {
        _push(`<!---->`);
      }
      if (unref(cloudStore).get_folder.parent_id !== null) {
        _push(`<button class="flex items-center" data-v-4a4f30c6><span class="text-sm tracking-widest" data-v-4a4f30c6>${ssrInterpolate(unref(cloudStore).folder.name)}</span></button>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="${ssrRenderClass([{ "flex-col flex w-full ": unref(selected).type === "list", "flex-wrap max-[400px]:flex-col max-[400px]:items-center ": unref(selected).type === "tile" }, "flex mt-4 gap-x-2 gap-y-3 max-md:justify-center select-none pr-2 mb-20"])}" data-v-4a4f30c6><!--[-->`);
      ssrRenderList((_d = unref(cloudStore)) == null ? void 0 : _d.get_folder.folders, (folders, i) => {
        var _a2, _b2, _c2, _d2;
        _push(`<div class="${ssrRenderClass({ "w-2/12 max-[1300px]:w-3/12 max-lg:w-4/12 max-md:w-6/12 max-sm:w-8/12": unref(selected).type === "tile" })}" data-v-4a4f30c6><div class="${ssrRenderClass([{ "w-full": unref(selected).type === "list" }, "relative"])}" data-v-4a4f30c6>`);
        _push(ssrRenderComponent(_sfc_main$7, {
          ...
          folderSvg: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<div data-v-4a4f30c6${_scopeId}><svg class="${ssrRenderClass([{ "w-[100px] h-[100px]": unref(selected).type === "tile" }, "icon"])}" width="50px" height="50px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId}><path d="M853.333333 256H469.333333l-85.333333-85.333333H170.666667c-46.933333 0-85.333333   38.4-85.333334 85.333333v170.666667h853.333334v-85.333334c0-46.933333-38.4-85.333333-85.333334-85.333333z" fill="#FFA000" data-v-4a4f30c6${_scopeId}></path><path d="M853.333333 256H170.666667c-46.933333 0-85.333333 38.4-85.333334 85.333333v426.666667c0 46.933333 38.4 85.333333 85.333334 85.333333h682.666666c46.933333 0 85.333333-38.4 85.333334-85.333333V341.333333c0-46.933333-38.4-85.333333-85.333334-85.333333z" fill="#FFCA28" data-v-4a4f30c6${_scopeId}></path></svg></div>`);
            } else {
              return [
          ...
          folderName: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              if (((_a3 = __props.folderObject) == null ? void 0 : _a3.id) === (folders == null ? void 0 : folders.id) && __props.showRead) {
                _push2(`<form class="flex items-center" data-v-4a4f30c6${_scopeId}><input class="${ssrRenderClass([{ "w-2/12 mx-auto text-center": unref(selected).type === "tile" }, "tracking-widest border-0 px-1 py-1 w-9/12 rounded-lg transition-all"])}" type="text"${ssrRenderAttr("value", unref(createFolder).name)}${ssrRenderAttr("placeholder", __props.folderObject.name)} data-v-4a4f30c6${_scopeId}><button type="submit" class="${ssrRenderClass({ "absolute top-2 left-2": unref(selected).type === "tile" })}" data-v-4a4f30c6${_scopeId}><svg class="stroke-green-500" width="30px" height="30px" viewBox="0 0 24 24" fill="none" data-v-4a4f30c6${_scopeId}><path d="M2 12C2 7.28595 2 4.92893 3.46447 3.46447C4.92893 2 7.28595 2 12 2C16.714 2 19.0711 2 20.5355 3.46447C22 4.92893 22 7.28595 22 12C22 16.714 22 19.0711 20.5355 20.5355C19.0711 22 16.714 22 12 22C7.28595 22 4.92893 22 3.46447 20.5355C2 19.0711 2 16.714 2 12Z" stroke-width="1.5" data-v-4a4f30c6${_scopeId}></path><path d="M8.5 12.5L10.5 14.5L15.5 9.5" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId}></path></svg></button></form>`);
              } else {
                _push2(`<div data-v-4a4f30c6${_scopeId}>${ssrInterpolate(((_b3 = folders.name) == null ? void 0 : _b3.length) > 20 ? folders.name.slice(0, 30) + "..." : folders.name)}</div>`);
              }
            } else {
              return [
        ...
        if (unref(selected).type === "tile" && unref(activeElem).id === (folders == null ? void 0 : folders.id)) {
          _push(`<div class="absolute top-2 right-2" data-v-4a4f30c6><svg class="dark:stroke-white stroke-black dark:hover:bg-gray-600 hover:bg-gray-300 rounded-full cursor-pointer transition-all duration-200" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6><path d="M12 12H12.01M12 6H12.01M12 18H12.01M13 12C13 12.5523 12.5523 13 12 13C11.4477 13 11 12.5523 11 12C11 11.4477 11.4477 11 12 11C12.5523 11 13 11.4477 13 12ZM13 18C13 18.5523 12.5523 19 12 19C11.4477 19 11 18.5523 11 18C11 17.4477 11.4477 17 12 17C12.5523 17 13 17.4477 13 18ZM13 6C13 6.55228 12.5523 7 12 7C11.4477 7 11 6.55228 11 6C11 5.44772 11.4477 5 12 5C12.5523 5 13 5.44772 13 6Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6></path></svg></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div>`);
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (folders.active === true) {
                _push2(`<div class="relative z-[100]" data-v-4a4f30c6${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$5, {
                  onClick: ($event) => {
                  ...
                  ContextMenuSvg: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg class="stroke-black dark:stroke-white" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId2}><path d="M21.2799 6.40005L11.7399 15.94C10.7899 16.89 7.96987 17.33 7.33987 16.7C6.70987 16.07 7.13987 13.25 8.08987 12.3L17.6399 2.75002C17.8754 2.49308 18.1605 2.28654 18.4781 2.14284C18.7956 1.99914 19.139 1.92124 19.4875 1.9139C19.8359 1.90657 20.1823 1.96991 20.5056 2.10012C20.8289 2.23033 21.1225 2.42473 21.3686 2.67153C21.6147 2.91833 21.8083 3.21243 21.9376 3.53609C22.0669 3.85976 22.1294 4.20626 22.1211 4.55471C22.1128 4.90316 22.0339 5.24635 21.8894 5.5635C21.7448 5.88065 21.5375 6.16524 21.2799 6.40005V6.40005Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path><path d="M11 4H6C4.93913 4 3.92178 4.42142 3.17163 5.17157C2.42149 5.92172 2 6.93913 2 8V18C2 19.0609 2.42149 20.0783 3.17163 20.8284C3.92178 21.5786 4.93913 22 6 22H17C19.21 22 20 20.2 20 18V13" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                ...
                _push2(ssrRenderComponent(_sfc_main$5, {
                  ...
                  ContextMenuSvg: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId2}><path d="M22 14C22 17.7712 22 19.6569 20.8284 20.8284C19.6569 22 17.7712 22 14 22H10C6.22876 22 4.34315 22 3.17157 20.8284C2.51839 20.1752 2.22937 19.3001 2.10149 18M2 12V6.94975C2 6.06722 2 5.62595 2.06935 5.25839C2.37464 3.64031 3.64031 2.37464 5.25839 2.06935C5.62595 2 6.06722 2 6.94975 2C7.33642 2 7.52976 2 7.71557 2.01738C8.51665 2.09229 9.27652 2.40704 9.89594 2.92051C10.0396 3.03961 10.1763 3.17633 10.4497 3.44975L11 4C11.8158 4.81578 12.2237 5.22367 12.7121 5.49543C12.9804 5.64471 13.2651 5.7626 13.5604 5.84678C14.0979 6 14.6747 6 15.8284 6H16.2021C18.8345 6 20.1506 6 21.0062 6.76946C21.0849 6.84024 21.1598 6.91514 21.2305 6.99383C21.8004 7.62741 21.9482 8.51364 21.9866 10" stroke-width="1.5" stroke-linecap="round" data-v-4a4f30c6${_scopeId2}></path><path d="M2 15C8.44365 15 6.55635 15 13 15M13 15L8.875 12M13 15L8.875 18" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          class: "dark:stroke-white stroke-black",
                ...
                _push2(ssrRenderComponent(_sfc_main$5, {
                  ...
                  ContextMenuSvg: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId2}><path d="M10 12V17" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path><path d="M14 12V17" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path><path d="M4 7H20" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path><path d="M6 10V18C6 19.6569 7.34315 21 9 21H15C16.6569 21 18 19.6569 18 18V10" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path><path d="M9 5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5V7H9V5Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          class: "dark:stroke-white stroke-black",
                ...
                _push2(ssrRenderComponent(_sfc_main$5, {
                  ...
                  ContextMenuSvg: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId2}><path d="M12 14.5V16.5M7 10.0288C7.47142 10 8.05259 10 8.8 10H15.2C15.9474 10 16.5286 10 17 10.0288M7 10.0288C6.41168 10.0647 5.99429 10.1455 5.63803 10.327C5.07354 10.6146 4.6146 11.0735 4.32698 11.638C4 12.2798 4 13.1198 4 14.8V16.2C4 17.8802 4 18.7202 4.32698 19.362C4.6146 19.9265 5.07354 20.3854 5.63803 20.673C6.27976 21 7.11984 21 8.8 21H15.2C16.8802 21 17.7202 21 18.362 20.673C18.9265 20.3854 19.3854 19.9265 19.673 19.362C20 18.7202 20 17.8802 20 16.2V14.8C20 13.1198 20 12.2798 19.673 11.638C19.3854 11.0735 18.9265 10.6146 18.362 10.327C18.0057 10.1455 17.5883 10.0647 17 10.0288M7 10.0288V8C7 5.23858 9.23858 3 12 3C14.7614 3 17 5.23858 17 8V10.0288" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-4a4f30c6${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          class: "dark:stroke-white stroke-black",
      ...
      ssrRenderList((_e = unref(cloudStore)) == null ? void 0 : _e.get_all_files, (file) => {
        ...
        _push(ssrRenderComponent(_sfc_main$6, {
          ...
          fileSvg: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<svg xmlns="http://www.w3.org/2000/svg" class="${ssrRenderClass({ "w-[100px] h-[100px]": unref(selected).type === "tile" })}" width="50px" height="50px" viewBox="0 0 56 64" enable-background="new 0 0 56 64" xml:space="preserve" data-v-4a4f30c6${_scopeId}><g data-v-4a4f30c6${_scopeId}><path fill="#8C181A" d="M5.1,0C2.3,0,0,2.3,0,5.1v53.8C0,61.7,2.3,64,5.1,64h45.8c2.8,0,5.1-2.3,5.1-5.1V20.3L37.1,0H5.1z" data-v-4a4f30c6${_scopeId}></path><path fill="#6B0D12" d="M56,20.4v1H43.2c0,0-6.3-1.3-6.1-6.7c0,0,0.2,5.7,6,5.7H56z" data-v-4a4f30c6${_scopeId}></path><path opacity="0.5" fill="#FFFFFF" enable-background="new" d="M37.1,0v14.6c0,1.7,1.1,5.8,6.1,5.8H56L37.1,0z" data-v-4a4f30c6${_scopeId}></path></g><path fill="#FFFFFF" d="M14.9,49h-3.3v4.1c0,0.4-0.3,0.7-0.8,0.7c-0.4,0-0.7-0.3-0.7-0.7V42.9c0-0.6,0.5-1.1,1.1-1.1h3.7
                      ...
                      C42.2,42.8,41.9,43.1,41.5,43.1z" data-v-4a4f30c6${_scopeId}></path></svg>`);
            } else {
              return [
                (openBlock(), createBlock("svg", {
                  xmlns: "http://www.w3.org/2000/svg",
          ...
          fileName: withCtx((_, _push2, _parent2, _scopeId) => {
            ...
            if (_push2) {
              if (((_a3 = __props.folderObject) == null ? void 0 : _a3.id) === (file == null ? void 0 : file.id) && __props.showRead) {
                ...
                _push2(`<div data-v-4a4f30c6${_scopeId}>${ssrInterpolate(file.name)}</div>`);
              }
            } else {
              return [
          ...
          folderSvg: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              if (unref(cloudStore).get_hasFileInBin || unref(cloudStore).get_bin.files.length > 0 || unref(cloudStore).get_bin.folders.length > 0) {
                _push2(`<svg class="" class="${ssrRenderClass([{ "w-[100px] h-[100px]": unref(selected).type === "tile" }, ""])}" width="50px" height="50px" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId}><path d="M512 454.4L270.933333 213.333333 554.666667 36.266667 817.066667 213.333333z" fill="#FFA000" data-v-4a4f30c6${_scopeId}></path><path d="M512 454.4L270.933333 213.333333 362.666667 100.266667 817.066667 213.333333z" fill="#FFCA28" data-v-4a4f30c6${_scopeId}></path><path d="M652.8 938.666667H371.2c-42.666667 0-78.933333-29.866667-85.333333-72.533334L192 234.666667h640l-96 631.466666c-6.4 42.666667-42.666667 72.533333-83.2 72.533334z" fill="#3fb1c9" data-v-4a4f30c6${_scopeId}></path><path d="M810.666667 277.333333H213.333333c-23.466667 0-42.666667-19.2-42.666666-42.666666s19.2-42.666667 42.666666-42.666667h597.333334c23.466667 0 42.666667 19.2 42.666666 42.666667s-19.2 42.666667-42.666666 42.666666z" fill="#0077B6" data-v-4a4f30c6${_scopeId}></path></svg>`);
              } else {
                _push2(`<svg class="${ssrRenderClass({ "w-[100px] h-[100px]": unref(selected).type == "tile", "w-[50px] h-[50px]": unref(selected).type == "list" })}" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" data-v-4a4f30c6${_scopeId}><path d="M652.8 938.666667H371.2c-42.666667 0-78.933333-29.866667-85.333333-72.533334L192 234.666667h640l-96 631.466666c-6.4 42.666667-42.666667 72.533333-83.2 72.533334z" fill="#3fb1c9" data-v-4a4f30c6${_scopeId}></path><path d="M810.666667 277.333333H213.333333c-23.466667 0-42.666667-19.2-42.666666-42.666666s19.2-42.666667 42.666666-42.666667h597.333334c23.466667 0 42.666667 19.2 42.666666 42.666667s-19.2 42.666667-42.666666 42.666666z" fill="#0077B6" data-v-4a4f30c6${_scopeId}></path></svg>`);
              }
            } else {
              return [
        ...
        _push(ssrRenderComponent(_sfc_main$8, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<div data-v-4a4f30c6${_scopeId}><form data-v-4a4f30c6${_scopeId}><h3 data-v-4a4f30c6${_scopeId}>\u041D\u0430\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u043D\u0438\u0435</h3>`);
              _push2(ssrRenderComponent(_sfc_main$a, {
                type: "text",
                modelValue: unref(createFolder).name,
                "onUpdate:modelValue": ($event) => unref(createFolder).name = $event
              }, null, _parent2, _scopeId));
              _push2(`<div class="flex justify-center gap-x-10 mt-10" data-v-4a4f30c6${_scopeId}>`);
...
const TheCloudUIFolders = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["__scopeId", "data-v-4a4f30c6"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_UContextMenu, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="" data-v-1e530da3${_scopeId}><div class="dark:hover:bg-gray-500 hover:bg-gray-200 p-2 cursor-pointer flex items-center gap-x-10" data-v-1e530da3${_scopeId}><div data-v-1e530da3${_scopeId}><svg class="stroke-black dark:stroke-white" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-1e530da3${_scopeId}><path d="M21.2799 6.40005L11.7399 15.94C10.7899 16.89 7.96987 17.33 7.33987 16.7C6.70987 16.07 7.13987 13.25 8.08987 12.3L17.6399 2.75002C17.8754 2.49308 18.1605 2.28654 18.4781 2.14284C18.7956 1.99914 19.139 1.92124 19.4875 1.9139C19.8359 1.90657 20.1823 1.96991 20.5056 2.10012C20.8289 2.23033 21.1225 2.42473 21.3686 2.67153C21.6147 2.91833 21.8083 3.21243 21.9376 3.53609C22.0669 3.85976 22.1294 4.20626 22.1211 4.55471C22.1128 4.90316 22.0339 5.24635 21.8894 5.5635C21.7448 5.88065 21.5375 6.16524 21.2799 6.40005V6.40005Z" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path d="M11 4H6C4.93913 4 3.92178 4.42142 3.17163 5.17157C2.42149 5.92172 2 6.93913 2 8V18C2 19.0609 2.42149 20.0783 3.17163 20.8284C3.92178 21.5786 4.93913 22 6 22H17C19.21 22 20 20.2 20 18V13" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path></svg></div><p data-v-1e530da3${_scopeId}>${ssrInterpolate(_ctx.$t("\u041F\u0435\u0440\u0435\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u0442\u044C"))}</p></div><div class="dark:hover:bg-gray-500 hover:bg-gray-200 p-2 cursor-pointer flex items-center gap-x-10" data-v-1e530da3${_scopeId}><div data-v-1e530da3${_scopeId}><svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-1e530da3${_scopeId}><path data-v-965c8b16="" d="M12 11L12 16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path data-v-965c8b16="" d="M14.5 13.5L9.5 13.5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path data-v-965c8b16="" d="M3 9.312C3 4.93757 3.93757 4 8.312 4H9.92963C10.5983 4 11.2228 4.3342 11.5937 4.8906L12.4063 6.1094C12.7772 6.6658 13.4017 7 14.0704 7C15.9647 7 17.8145 7 19.1258 7C20.1807 7 21.0128 7.82095 21.0029 8.8758C21.0013 9.05376 21 9.20638 21 9.312V14.688C21 19.0624 20.0624 20 15.688 20H8.312C3.93757 20 3 19.0624 3 14.688V9.312Z" stroke-width="2" data-v-1e530da3${_scopeId}></path></svg></div><p data-v-1e530da3${_scopeId}>${ssrInterpolate(_ctx.$t("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043F\u0430\u043F\u043A\u0443"))}</p></div><div class="dark:hover:bg-gray-500 hover:bg-gray-200 p-2 cursor-pointer flex items-center gap-x-10" data-v-1e530da3${_scopeId}><div data-v-1e530da3${_scopeId}><svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-1e530da3${_scopeId}><path d="M10 12V17" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path d="M14 12V17" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path d="M4 7H20" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path d="M6 10V18C6 19.6569 7.34315 21 9 21H15C16.6569 21 18 19.6569 18 18V10" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path d="M9 5C9 3.89543 9.89543 3 11 3H13C14.1046 3 15 3.89543 15 5V7H9V5Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path></svg></div><p data-v-1e530da3${_scopeId}>${ssrInterpolate(_ctx.$t("\u0423\u0431\u0440\u0430\u0442\u044C \u0432 \u043A\u043E\u0440\u0437\u0438\u043D\u0443"))}</p></div></div>`);
          } else {
            return [
      ...
      _push(ssrRenderComponent(TheContentBlock, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-1e530da3${_scopeId}><div class="${ssrRenderClass([{ "max-[840px]:hidden": __props.activeStructure === false }, "absolute bg-gray-300 rounded-l-lg px-2 hidden max-[840px]:block right-0 top-0"])}" data-v-1e530da3${_scopeId}><svg width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-1e530da3${_scopeId}><path d="M16.9995 15.9995L20.9995 11.9995M20.9995 11.9995L16.9995 7.99951M20.9995 11.9995H8.99951M12.9995 20.9995H6.20029C5.08019 20.9995 4.52014 20.9995 4.09231 20.7815C3.71599 20.5898 3.41003 20.2838 3.21828 19.9075C3.00029 19.4797 3.00029 18.9196 3.00029 17.7995V6.19951C3.00029 5.07941 3.00029 4.51935 3.21828 4.09153C3.41003 3.71521 3.71599 3.40925 4.09231 3.2175C4.52014 2.99951 5.08019 2.99951 6.20029 2.99951L12.9995 2.99951" stroke="#000000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path></svg></div></div><div class="${ssrRenderClass([{ "max-[840px]:hidden": !__props.activeStructure }, "flex cursor-pointer dark:hover:bg-gray-500 p-2 transition-all duration-200 items-center gap-x-4 my-4 justify-center mx-auto"])}" data-v-1e530da3${_scopeId}><div data-v-1e530da3${_scopeId}><svg class="dark:stroke-white stroke-black" width="30px" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-1e530da3${_scopeId}><path d="M12 11L12 16" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path d="M14.5 13.5L9.5 13.5" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId}></path><path d="M3 9.312C3 4.93757 3.93757 4 8.312 4H9.92963C10.5983 4 11.2228 4.3342 11.5937 4.8906L12.4063 6.1094C12.7772 6.6658 13.4017 7 14.0704 7C15.9647 7 17.8145 7 19.1258 7C20.1807 7 21.0128 7.82095 21.0029 8.8758C21.0013 9.05376 21 9.20638 21 9.312V14.688C21 19.0624 20.0624 20 15.688 20H8.312C3.93757 20 3 19.0624 3 14.688V9.312Z" stroke-width="2" data-v-1e530da3${_scopeId}></path></svg></div><p class="tracking-widest dark:text-white" data-v-1e530da3${_scopeId}>${ssrInterpolate(_ctx.$t("\u0421\u043E\u0437\u0434\u0430\u0442\u044C \u043F\u0430\u043F\u043A\u0443"))}</p></div>`);
              ...
              _push2(ssrRenderComponent(_sfc_main$8, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<form data-v-1e530da3${_scopeId2}><div class="flex items-center justify-center gap-x-10 my-10" data-v-1e530da3${_scopeId2}>`);
                    ...
                    _push3(`<div class="w-6/12 flex flex-col gap-y-2" data-v-1e530da3${_scopeId2}><p class="tracking-widest dark:text-white" data-v-1e530da3${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0420\u0430\u0441\u043F\u043E\u043B\u043E\u0436\u0435\u043D\u0438\u0435 \u043F\u0430\u043F\u043A\u0438"))}</p><select class="w-full p-2.5 rounded-md dark:bg-gray-300" data-v-1e530da3${_scopeId2}><option value="" data-v-1e530da3${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041D\u0430\u0438\u043C\u0435\u043D\u043E\u0432\u0430\u043D\u0438\u0435"))}</option></select></div></div><div class="flex justify-center gap-x-10" data-v-1e530da3${_scopeId2}>`);
            ...
            _push2(`<div class="${ssrRenderClass({ "max-[840px]:hidden": !__props.activeStructure })}" data-v-1e530da3${_scopeId}><div data-v-1e530da3${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$3, null, {
              ...
              structureSvg: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-1e530da3${_scopeId2}><path d="M12 7V12L14.5 10.5M21 12C21 16.9706 16.9706 21 12 21C7.02944 21 3 16.9706 3 12C3 7.02944 7.02944 3 12 3C16.9706 3 21 7.02944 21 12Z" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-1e530da3${_scopeId2}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      class: "dark:stroke-white stroke-black",
...
const TheCloudUiStructure = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-1e530da3"]]);
...
//# sourceMappingURL=index-C5iMKlsN.mjs.map
