...
import { _ as _sfc_main$7 } from './TheFilter-DKS5ijl0.mjs';
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  ...
                  if (_push3) {
                    ...
                    if (!((_a2 = unref(userList)) == null ? void 0 : _a2.get_position_list)) {
                      ...
                      ssrRenderList((_b2 = unref(userList)) == null ? void 0 : _b2.get_position_list, (position) => {
                    ...
                    return [
                      createVNode("div", { class: "w-6/12 max-lg:w-full" }, [
                        ...
                        !((_c2 = unref(userList)) == null ? void 0 : _c2.get_position_list) ? (openBlock(), createBlock(_sfc_main$a, {
                          key: 0,
                          type: "text",
                          name: "text",
                          label: "\u0414\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u044C",
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList((_d2 = unref(userList)) == null ? void 0 : _d2.get_position_list, (position) => {
                      ...
                      return [
                        createVNode("div", { class: "w-6/12 max-lg:w-full" }, [
                          ...
                          !((_a2 = unref(userList)) == null ? void 0 : _a2.get_position_list) ? (openBlock(), createBlock(_sfc_main$a, {
                            ...
                            (openBlock(true), createBlock(Fragment, null, renderList((_b2 = unref(userList)) == null ? void 0 : _b2.get_position_list, (position) => {
                              return openBlock(), createBlock("option", {
                                value: position.name
                              }, toDisplayString(position.name), 9, ["value"]);
                            }), 256))
...
//# sourceMappingURL=index-DaGW85-i.mjs.map
