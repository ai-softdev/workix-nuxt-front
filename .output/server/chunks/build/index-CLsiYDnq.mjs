...
import { useSSRContext, defineComponent, mergeProps, withCtx, unref, createVNode, toDisplayString, openBlock, createBlock, ref, watch, watchSyncEffect, createTextVNode, createCommentVNode, withDirectives, vModelText, Fragment, renderList, vModelSelect, withModifiers } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderClass, ssrRenderList, ssrIncludeBooleanAttr, ssrRenderSlot } from 'vue/server-renderer';
import { _ as _sfc_main$6 } from './TheButton-DDcCSWqY.mjs';
import { _ as _sfc_main$9 } from './TheInput-BfTT2E6G.mjs';
import { _ as _sfc_main$7 } from './TheModal-CnBva0fQ.mjs';
import { _ as _sfc_main$8 } from './TheTextContent-D3-WrEaf.mjs';
...
const _imports_0 = "" + publicAssetsURL("icons/email.svg");
const _imports_1 = "" + publicAssetsURL("icons/phone.svg");
const _imports_2 = "" + publicAssetsURL("icons/password.svg");
const _sfc_main$4 = {};
...
const _sfc_main$3 = {
  ...
  setup(__props) {
    ...
    function loads() {
      ...
      userList.loadUserCreateList({ page: 1, limit: 1e3 });
        ...
        _push(ssrRenderComponent(_sfc_main$7, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(ssrRenderComponent(_sfc_main$8, { class: "!text-start font-bold !text-3xl" }, {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  ...
                  if (_push3) {
                    if (unref(loadCurrentUser).user.role.name_en === "company_admin") {
                      ...
                      ssrRenderList((_a = unref(company)) == null ? void 0 : _a.get_all_department.results, (department) => {
                    ...
                    return [
                      unref(loadCurrentUser).user.role.name_en === "company_admin" ? (openBlock(), createBlock("div", {
                        ...
                        withDirectives(createVNode("select", {
                          ...
                          (openBlock(true), createBlock(Fragment, null, renderList((_b = unref(company)) == null ? void 0 : _b.get_all_department.results, (department) => {
              ...
              _push2(ssrRenderComponent(UserContentCreateElems, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  ...
                  if (_push3) {
                    ...
                    _push3(`<select class="dark:text-white w-full dark:bg-gray-300 bg-whiteSmoke rounded-full p-2 dark:border-none text-black border focus:outline-golden mt-2 outline-1"${ssrIncludeBooleanAttr(!((_c = (_b = unref(userList)) == null ? void 0 : _b.get_user_create_list) == null ? void 0 : _c.results)) ? " disabled" : ""}${_scopeId2}><!--[-->`);
                    ssrRenderList((_e = (_d = unref(userList)) == null ? void 0 : _d.usersForCreate) == null ? void 0 : _e.results, (participant) => {
                    ...
                    return [
                      createVNode("div", { class: "w-6/12 max-lg:w-full" }, [
                        ...
                        !((_f = unref(userList)) == null ? void 0 : _f.get_position_list) ? (openBlock(), createBlock(_sfc_main$9, {
                          key: 0,
                          type: "text",
                          name: "text",
                          label: "\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C",
                        ...
                        withDirectives(createVNode("select", {
                          "onUpdate:modelValue": ($event) => unref(createForm).head_user_id = $event,
                          class: "dark:text-white w-full dark:bg-gray-300 bg-whiteSmoke rounded-full p-2 dark:border-none text-black border focus:outline-golden mt-2 outline-1",
                          disabled: !((_h = (_g = unref(userList)) == null ? void 0 : _g.get_user_create_list) == null ? void 0 : _h.results)
                        }, [
                          (openBlock(true), createBlock(Fragment, null, renderList((_j = (_i = unref(userList)) == null ? void 0 : _i.usersForCreate) == null ? void 0 : _j.results, (participant) => {
              ...
              return [
                createVNode("div", { class: "p-6 !pb-0" }, [
                  createVNode(_sfc_main$8, { class: "!text-start font-bold !text-3xl" }, {
                    default: withCtx(() => [
                      createTextVNode(toDisplayString(_ctx.$t("\u0421\u043E\u0437\u0434\u0430\u043D\u0438\u0435 \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F")), 1)
                    ]),
                    _: 1
                  ...
                  createVNode("form", {
                    ...
                    onSubmit: withModifiers(($event) => {
                      var _a;
                      return ((_a = unref(loadCurrentUser).user.role) == null ? void 0 : _a.name_en) === "admin" ? createAdmin() : createUser();
                    }, ["prevent"])
                  }, [
                        ...
                        return [
                          unref(loadCurrentUser).user.role.name_en === "company_admin" ? (openBlock(), createBlock("div", {
                            ...
                            withDirectives(createVNode("select", {
                              ...
                              (openBlock(true), createBlock(Fragment, null, renderList((_a = unref(company)) == null ? void 0 : _a.get_all_department.results, (department) => {
                                return openBlock(), createBlock("option", { value: department }, toDisplayString(department.name), 9, ["value"]);
                              }), 256))
                            ], 8, ["onUpdate:modelValue"]), [
                              [vModelSelect, unref(createForm).department]
                    ...
                    createVNode(UserContentCreateElems, null, {
                      default: withCtx(() => {
                        ...
                        return [
                          createVNode("div", { class: "w-6/12 max-lg:w-full" }, [
                            createVNode("p", { class: "text-md dark:text-white font-medium" }, toDisplayString(_ctx.$t("\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C")), 1),
                            !((_a = unref(userList)) == null ? void 0 : _a.get_position_list) ? (openBlock(), createBlock(_sfc_main$9, {
                              key: 0,
                              type: "text",
                              name: "text",
                              label: "\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C",
                            ...
                            withDirectives(createVNode("select", {
                              "onUpdate:modelValue": ($event) => unref(createForm).head_user_id = $event,
                              class: "dark:text-white w-full dark:bg-gray-300 bg-whiteSmoke rounded-full p-2 dark:border-none text-black border focus:outline-golden mt-2 outline-1",
                              disabled: !((_c = (_b = unref(userList)) == null ? void 0 : _b.get_user_create_list) == null ? void 0 : _c.results)
                            }, [
                              (openBlock(true), createBlock(Fragment, null, renderList((_e = (_d = unref(userList)) == null ? void 0 : _d.usersForCreate) == null ? void 0 : _e.results, (participant) => {
                                return openBlock(), createBlock("option", {
                                  key: participant.id,
                                  value: participant.id
                                }, toDisplayString(participant.first_name) + " " + toDisplayString(participant.last_name), 9, ["value"]);
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const isValidLink = (nameEn) => {
      var _a;
      const foundItem = (_a = loadCurrentUser.user.permissions) == null ? void 0 : _a.find((item) => item.name_en === nameEn);
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</div>`);
      if (isValidLink("user.create")) {
        _push(`<div class="${ssrRenderClass({ "flex items-center justify-evenly": ((_c = unref(loadCurrentUser).user.role) == null ? void 0 : _c.name_en) === "admin", "w-2/12 max-lg:w-4/12 max-sm:w-full max-sm:mb-6 max-sm:mx-auto": unref(loadCurrentUser).user.role_en !== "admin" })}">`);
      ...
      _push(`</div><div class="w-full mt-4 max-[636px]:mt-0"><div class="flex items-center justify-between max-[636px]:flex-col gap-x-10 max-lg:flex-wrap max-md:justify-center"><p class="text-mediumGray w-5/12 max-[636px]:w-full">${ssrInterpolate(_ctx.$t("\u0414\u0430\u043D\u043D\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430 \u0445\u0440\u0430\u043D\u0438\u0442 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044E \u043E \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F\u0445 \u0434\u0430\u043D\u043D\u043E\u0439 \u043F\u043B\u0430\u0442\u0444\u043E\u0440\u043C\u044B"))}</p><div class="w-5/12 max-[636px]:w-full max-[636px]:mt-5 flex items-center gap-3 h-10">`);
...
//# sourceMappingURL=index-CLsiYDnq.mjs.map
