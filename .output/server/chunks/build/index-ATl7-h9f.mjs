import { useSSRContext, defineComponent, watchEffect, unref, withCtx, createTextVNode, toDisplayString, openBlock, createBlock, createVNode, ref, withModifiers, mergeProps, createCommentVNode, Fragment, renderList, Transition, reactive } from 'vue';
...
import { _ as _sfc_main$f } from './TheSearch-Dw2_cWOE.mjs';
import { _ as _sfc_main$g } from './TheButton-RleONNaZ.mjs';
import { _ as _sfc_main$h } from './TheModal-DcnSgpbI.mjs';
import { _ as _sfc_main$i } from './TheInput-BfTT2E6G.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (((_a = unref(currentUser).user.role) == null ? void 0 : _a.name_en) !== "admin") {
        ...
        _push(ssrRenderComponent(_sfc_main$f, { class: "my-10 w-6/12 max-md:w-full" }, null, _parent));
        _push(ssrRenderComponent(_sfc_main$c, { class: "w-2/12 max-md:w-full" }, null, _parent));
...
//# sourceMappingURL=index-ATl7-h9f.mjs.map
