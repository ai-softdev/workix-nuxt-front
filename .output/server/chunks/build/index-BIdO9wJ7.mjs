import { useSSRContext, defineComponent, computed, ref, watch, unref, mergeProps, createSlots, withCtx, openBlock, createBlock, createVNode, createTextVNode, toDisplayString, isRef, createCommentVNode, watchEffect, withDirectives, Fragment, renderList, vModelSelect, withModifiers, resolveComponent } from 'vue';
import { a as useRouter, l as useSeoMeta } from './server.mjs';
import { ssrRenderAttrs, ssrInterpolate, ssrRenderComponent, ssrRenderClass, ssrRenderAttr, ssrRenderSlot, ssrRenderList, ssrRenderStyle } from 'vue/server-renderer';
...
import { _ as _sfc_main$c } from './TheModal-CnBva0fQ.mjs';
...
import { _ as _sfc_main$e } from './TheTextContent-D3-WrEaf.mjs';
import { _ as _sfc_main$f } from './TheInput-BfTT2E6G.mjs';
import { u as useCompanies } from './companies-Dkc8gjfT.mjs';
import { T as TheCheckbox } from './TheCheckbox-ofUcLYsF.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="flex items-center gap-4 justify-between max-[680px]:flex-col max-[680px]:items-start max-[680px]:gap-5"><p class="dark:text-white text-3xl font-bold">${ssrInterpolate(_ctx.$t("\u0417\u0430\u0434\u0430\u043D\u0438\u044F"))}</p></div><div class="mt-8 flex max-[1170px]:flex-col max-lg:items-center justify-between"><div class="flex flex-col w-full max-xl:flex-wrap gap-y-10 max-xl:items-center"><div class="w-full mx-auto">`);
...
//# sourceMappingURL=index-BIdO9wJ7.mjs.map
