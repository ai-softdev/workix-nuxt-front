...
import { u as useUserStore } from './users-BEPo3Qg_.mjs';
                    ...
                    if (_push3) {
                      ...
                      return [
                        createVNode("div", { class: "w-6/12 max-lg:w-full" }, [
                          ...
                          !((_b2 = unref(userList)) == null ? void 0 : _b2.get_position_list) ? (openBlock(), createBlock(_sfc_main$9, {
                            key: 0,
                            type: "text",
                            name: "text",
                            label: "\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C",
                    ...
                    ((_d = (_c = unref(createForm).department) == null ? void 0 : _c.participants) == null ? void 0 : _d.length) ? (openBlock(), createBlock(UserContentCreateElems, { key: 0 }, {
                      default: withCtx(() => {
                        ...
                        return [
                          createVNode("div", { class: "w-6/12 max-lg:w-full" }, [
                            createVNode("p", { class: "text-md dark:text-white font-medium" }, toDisplayString(_ctx.$t("\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C")), 1),
                            !((_a2 = unref(userList)) == null ? void 0 : _a2.get_position_list) ? (openBlock(), createBlock(_sfc_main$9, {
                              key: 0,
                              type: "text",
                              name: "text",
                              label: "\u0420\u0443\u043A\u043E\u0432\u043E\u0434\u0438\u0442\u0435\u043B\u044C",
      ...
      _push(ssrRenderComponent(_component_NuxtLink, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "flex items-center max-md:w-4/12 gap-x-2 max-lg:mx-auto pb-4 border-b" }, [
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-4" }, _attrs))}><div class="${ssrRenderClass([{ "flex items-center justify-between": ["company_admin", "admin"].includes((_a = unref(loadCurrentUser).user.role) == null ? void 0 : _a.name_en) }, "flex items-center justify-between gap-10"])}"><div class="text-lg flex gap-x-10">`);
      ...
      _push(`</div></div><div class="w-full mt-4"><div class="flex items-center justify-between gap-x-10 max-lg:flex-wrap max-md:justify-center"><p class="text-mediumGray w-5/12">${ssrInterpolate(_ctx.$t("\u0414\u0430\u043D\u043D\u0430\u044F \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0430 \u0445\u0440\u0430\u043D\u0438\u0442 \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044E \u043E \u043F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u044F\u0445 \u0434\u0430\u043D\u043D\u043E\u0439 \u043F\u043B\u0430\u0442\u0444\u043E\u0440\u043C\u044B"))}</p><div class="w-5/12 flex items-center gap-3 h-10">`);
      ...
      _push(`</div></div><div class="mt-8 grid grid-cols-4 gap-5 max-md:mt-10">`);
...
//# sourceMappingURL=index-BOtN99bE.mjs.map
