...
import { _ as _sfc_main$9 } from './TheInput-CZSlzGOT.mjs';
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex flex-col gap-4" }, _attrs))}><div class="${ssrRenderClass({ "flex flex-wrap items-center justify-between": ["company_admin", "admin"].includes((_a = unref(loadCurrentUser).user.role) == null ? void 0 : _a.name_en) })}"><div class="text-lg flex gap-x-10">`);
...
//# sourceMappingURL=index-BLWRV3nh.mjs.map
