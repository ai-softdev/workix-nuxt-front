...
import { useSSRContext, defineComponent, mergeProps, ref, unref, reactive, computed, withCtx, createTextVNode, toDisplayString, createVNode, withModifiers, openBlock, createBlock } from 'vue';
...
import { _ as _sfc_main$6 } from './TheModal-CnBva0fQ.mjs';
import { _ as _sfc_main$8 } from './TheButton-DDcCSWqY.mjs';
...
import { u as useTaskList } from './tasks-DX-xK1Wx.mjs';
      ...
      if (__props.showInfo) {
        _push(ssrRenderComponent(_sfc_main$6, {
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              _push2(`<form class="p-6 relative"${_scopeId}><div${_scopeId}><h2 class="text-2xl font-bold dark:text-white"${_scopeId}>\u041B\u0438\u0447\u043D\u0430\u044F \u0438\u043D\u0444\u043E\u0440\u043C\u0430\u0446\u0438\u044F</h2></div><div class="w-full mt-8"${_scopeId}><div class="mt-10 flex items-center justify-around bg-whiteLilia p-8 rounded-3xl pb-6 border-b mb-6"${_scopeId}><div class="flex items-center gap-3 dark:text-white border-r pr-10"${_scopeId}><p class="dark:text-gray-200 font-bold text-md"${_scopeId}>${ssrInterpolate(_ctx.$t("\u0414\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u044C:"))}</p><p class="bg-white rounded-xl py-2 px-4 shadow"${_scopeId}>${ssrInterpolate(__props.userEdit.position.name)}</p></div><div class="flex items-center gap-3 dark:text-white"${_scopeId}><p class="dark:text-gray-200 font-bold text-md"${_scopeId}>${ssrInterpolate(_ctx.$t("\u0417\u0430\u0440\u0430\u0431\u043E\u0442\u043D\u0430\u044F \u043F\u043B\u0430\u0442\u0430:"))}</p>`);
              ...
              _push2(`</div></div><div class="grid grid-cols-2 gap-5 mb-12"${_scopeId}>`);
              ...
              _push2(`</div><div class="flex items-center justify-center gap-5"${_scopeId}>`);
              ...
              return [
                createVNode("form", {
                  ...
                  createVNode("div", { class: "w-full mt-8" }, [
                    createVNode("div", { class: "mt-10 flex items-center justify-around bg-whiteLilia p-8 rounded-3xl pb-6 border-b mb-6" }, [
                      createVNode("div", { class: "flex items-center gap-3 dark:text-white border-r pr-10" }, [
                        createVNode("p", { class: "dark:text-gray-200 font-bold text-md" }, toDisplayString(_ctx.$t("\u0414\u043E\u043B\u0436\u043D\u043E\u0441\u0442\u044C:")), 1),
                        createVNode("p", { class: "bg-white rounded-xl py-2 px-4 shadow" }, toDisplayString(__props.userEdit.position.name), 1)
                      ]),
                      createVNode("div", { class: "flex items-center gap-3 dark:text-white" }, [
                    ...
                    createVNode("div", { class: "grid grid-cols-2 gap-5 mb-12" }, [
...
//# sourceMappingURL=profile-BSus-vJk.mjs.map
