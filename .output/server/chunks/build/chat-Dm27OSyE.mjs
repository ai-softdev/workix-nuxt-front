...
import { useSSRContext, defineComponent, ref, onUnmounted, watch, mergeProps, unref, withCtx, openBlock, createBlock, createVNode, createTextVNode, toDisplayString, Transition, createCommentVNode, withDirectives, isRef, vModelText, Fragment, renderList, nextTick } from 'vue';
...
import { _ as _sfc_main$a } from './TheFileInput-_77pyCsA.mjs';
import { Preview } from 'vue-advanced-cropper';
import { _ as _sfc_main$1$1, a as _sfc_main$b } from './TheChatAvatar-C7zFbNKN.mjs';
          ...
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              ssrRenderList(unref(chat).get_chat_list.results.filter((e) => !e.is_group), (item) => {
                _push2(ssrRenderComponent(_sfc_main$1$1, { item }, null, _parent2, _scopeId));
              });
              ...
              return [
                ...
                (openBlock(true), createBlock(Fragment, null, renderList(unref(chat).get_chat_list.results.filter((e) => !e.is_group), (item) => {
                  return openBlock(), createBlock(_sfc_main$1$1, { item }, null, 8, ["item"]);
                }), 256)),
      ...
      if (unref(chatStore).searchElem !== "") {
        ...
        ssrRenderList(unref(userStore).get_user_search.results, (userSearchList) => {
          _push(ssrRenderComponent(_component_NuxtLink, {
            ...
            onClick: ($event) => {
              var _a;
              userSearchList.id !== ((_a = unref(chatStore).get_user_chat.user) == null ? void 0 : _a.id) ? unref(chatStore).createChatUser({ user_id: userSearchList.id }) : () => {
            ...
            default: withCtx((_, _push2, _parent2, _scopeId) => {
              var _a, _b;
              if (_push2) {
                _push2(`${ssrInterpolate(userSearchList.id !== ((_a = unref(chatStore).get_user_chat.user) == null ? void 0 : _a.id))} <img class="w-[50px] h-[50px] rounded-full"${ssrRenderAttr("src", userSearchList.photo)} alt="use-photo"${_scopeId}><p class="text-sm break-words font-bold"${_scopeId}>${ssrInterpolate(userSearchList.first_name + " " + userSearchList.last_name)}</p>`);
              } else {
                return [
                  createTextVNode(toDisplayString(userSearchList.id !== ((_b = unref(chatStore).get_user_chat.user) == null ? void 0 : _b.id)) + " ", 1),
                  createVNode("img", {
...
//# sourceMappingURL=chat-Dm27OSyE.mjs.map
