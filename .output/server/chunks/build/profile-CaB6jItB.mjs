...
import { _ as _sfc_main$7 } from './TheInput-BhoKAMvc.mjs';
...
const _imports_0$1 = "" + publicAssetsURL("icons/statistic.svg");
...
const _imports_0 = "" + publicAssetsURL("icons/profile.svg");
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      var _a;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "w-full p-6 relative bg-white shadow-cards max-sm:col-auto dark:shadow-md dark:border-t dark:border-t-gray-500 dark:shadow-gray-500 rounded-3xl hover:transform hover:-translate-y-2 transition-all duration-200" }, _attrs))}><div><div class="flex items-center justify-between mb-8"><div class="border rounded-full px-3 py-2 w-fit flex items-center gap-3"><img${ssrRenderAttr("src", _imports_0)} alt="profile"><h2 class="dark:text-white">${ssrInterpolate(_ctx.$t("\u041B\u0438\u0447\u043D\u044B\u0435 \u0434\u0430\u043D\u043D\u044B\u0435"))}</h2></div><button class="w-10 h-10 rounded-lg flex items-center justify-center bg-porcelain hover:bg-gray-300 transition-all ease-in-out duration-300"><img${ssrRenderAttr("src", _imports_1)} alt="profile"></button></div><div class="${ssrRenderClass({ "blur": !unref(loadCurrentUser).user.id })}"><div class="flex flex-col">`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="w-full col-span-2 p-6 bg-white dark:border-t dark:border-t-gray-500 dark:shadow-md shadow-cards dark:shadow-gray-500 rounded-3xl hover:transform hover:-translate-y-2 transition-all duration-200"><div class="border rounded-full px-3 py-2 w-fit flex items-center gap-3 mb-8"><img${ssrRenderAttr("src", _imports_0$1)} alt="statistic"><h2 class="dark:text-white">${ssrInterpolate(_ctx.$t("\u041B\u0438\u0447\u043D\u0430\u044F \u0441\u0442\u0430\u0442\u0438\u0441\u0442\u0438\u043A\u0430"))}</h2></div>`);
...
//# sourceMappingURL=profile-CaB6jItB.mjs.map
