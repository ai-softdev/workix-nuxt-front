...
import { u as useTreeStore, _ as _sfc_main$a } from './TheButton-BH_KWEhI.mjs';
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><button class="px-2 w-full text-start transition-all"><div class="items-center flex justify-between">`);
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-8027050c><div class="${ssrRenderClass([{ "px-3 py-[33px]": !unref(loadCurrentUser).activeNav, "px-6 py-[23px]": unref(loadCurrentUser).activeNav }, "flex w-full items-center transition-all justify-between text-center dark:bg-gray-600"])}" data-v-8027050c><img${ssrRenderAttr("src", _imports_0)} alt="" class="${ssrRenderClass([{ "w-[80px] transition-all": unref(loadCurrentUser).activeNav, "w-[50px] transition-all": !unref(loadCurrentUser).activeNav }, "transition-all mx-auto"])}" data-v-8027050c></div><div class="${ssrRenderClass([{ "pl-0": !unref(loadCurrentUser).activeNav, "max-md:w-full overflow-x-hidden ": unref(loadCurrentUser).activeNav, "top-0 fixed shadow-lg dark:border-none": unref(loadCurrentUser).my_scroll > 90, "max-[1151px]:w-[27%] max-[1149px]:w-full max-lg:w-full": unref(loadCurrentUser).activeNav && unref(loadCurrentUser).my_scroll > 100 }, "py-2 flex flex-col gap-y-4 transition-all duration-300 dark:bg-gray-600 max-h-screen max-[1150px]:pb-24 overflow-y-auto h-screen"])}" data-v-8027050c>`);
      _push(ssrRenderComponent(_sfc_main$2, null, {
        navTitleIcon: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="dark:fill-white fill-black" data-v-8027050c${_scopeId}><svg width="45px" height="45px" viewBox="-6 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId}><path d="M17 11.8c-0.28-1.4-1.4-2.52-2.84-2.84-0.36-1.68-1.84-2.92-3.6-2.92h-6.88c-2.040 0-3.68 1.64-3.68 3.68v6.88c0 1.76 1.24 3.24 2.92 3.6 0.28 1.4 1.4 2.52 2.84 2.84 0.36 1.68 1.84 2.92 3.6 2.92h6.88c2.040 0 3.68-1.64 3.68-3.68v-6.88c0-1.76-1.24-3.24-2.92-3.6zM18.24 15.4v6.88c0 0.080 0 0.16 0 0.24-0.48-1.12-1.32-2.080-2.4-2.72 0.24-0.48 0.36-1 0.36-1.56 0-1.88-1.52-3.4-3.4-3.4s-3.4 1.52-3.4 3.4c0 0.56 0.12 1.080 0.36 1.56-1.080 0.64-1.88 1.6-2.4 2.72 0-0.080 0-0.16 0-0.24v-6.88c0-1.12 0.88-2 2-2h6.88c1.12 0 2 0.88 2 2zM11.040 18.28c0-0.96 0.76-1.72 1.72-1.72s1.72 0.76 1.72 1.72c0 0.96-0.76 1.72-1.72 1.72-0.92 0-1.72-0.76-1.72-1.72zM1.68 16.6v-6.88c0-1.12 0.88-2 2-2h6.88c0.8 0 1.48 0.48 1.8 1.16h-5.84c-2.040 0-3.68 1.64-3.68 3.68v5.88c-0.68-0.32-1.16-1.040-1.16-1.84zM4.52 19.44v-6.88c0-1.12 0.88-2 2-2h6.88c0.8 0 1.48 0.48 1.8 1.16h-5.84c-2.040 0-3.68 1.64-3.68 3.68v5.88c-0.68-0.32-1.16-1.040-1.16-1.84zM9.36 24.28c-0.28 0-0.52-0.040-0.76-0.16 0-0.040 0.040-0.080 0.040-0.12 0.28-1.24 1.12-2.32 2.28-2.92 0.56 0.36 1.2 0.56 1.88 0.56s1.36-0.2 1.88-0.56c1.16 0.6 2 1.64 2.28 2.92 0 0.040 0.040 0.080 0.040 0.12-0.24 0.080-0.48 0.16-0.76 0.16h-6.88z" data-v-8027050c${_scopeId}></path></svg></div>`);
          } else {
            return [
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$3, { to: "/base/profile" }, {
              navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<svg width="25px" height="25px" class="stroke-black dark:stroke-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId2}><circle cx="12" cy="6" r="4" stroke-width="1.5" data-v-8027050c${_scopeId2}></circle><path d="M19.9975 18C20 17.8358 20 17.669 20 17.5C20 15.0147 16.4183 13 12 13C7.58172 13 4 15.0147 4 17.5C4 19.9853 4 22 12 22C14.231 22 15.8398 21.8433 17 21.5634" stroke="" stroke-width="1.5" stroke-linecap="round" data-v-8027050c${_scopeId2}></path></svg>`);
                } else {
                  return [
                    (openBlock(), createBlock("svg", {
                      width: "25px",
              ...
              navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041F\u0440\u043E\u0444\u0438\u043B\u044C"))}</p>`);
                } else {
                  return [
            ...
            if (((_c2 = (_b2 = (_a2 = unref(loadCurrentUser)) == null ? void 0 : _a2.user) == null ? void 0 : _b2.role) == null ? void 0 : _c2.name_en) !== "admin") {
              _push2(ssrRenderComponent(_sfc_main$3, { to: "/base/users" }, {
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId2}><g id="User / Users_Group" data-v-8027050c${_scopeId2}><path id="Vector" class="dark:stroke-white stroke-black" d="M17 20C17 18.3431 14.7614 17 12 17C9.23858 17 7 18.3431 7 20M21 17.0004C21 15.7702 19.7659 14.7129 18 14.25M3 17.0004C3 15.7702 4.2341 14.7129 6 14.25M18 10.2361C18.6137 9.68679 19 8.8885 19 8C19 6.34315 17.6569 5 16 5C15.2316 5 14.5308 5.28885 14 5.76389M6 10.2361C5.38625 9.68679 5 8.8885 5 8C5 6.34315 6.34315 5 8 5C8.76835 5 9.46924 5.28885 10 5.76389M12 14C10.3431 14 9 12.6569 9 11C9 9.34315 10.3431 8 12 8C13.6569 8 15 9.34315 15 11C15 12.6569 13.6569 14 12 14Z" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" data-v-8027050c${_scopeId2}></path></g></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        width: "25px",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041F\u043E\u043B\u044C\u0437\u043E\u0432\u0430\u0442\u0435\u043B\u0438"))}</p>`);
                  } else {
                    return [
            ...
            if (_push2) {
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("tasks")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg width="25px" height="25px" class="dark:fill-white fill-black" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId2}><path d="M13.25 8.5C12.8358 8.5 12.5 8.83579 12.5 9.25C12.5 9.66421 12.8358 10 13.25 10H16.75C17.1642 10 17.5 9.66421 17.5 9.25C17.5 8.83579 17.1642 8.5 16.75 8.5H13.25Z" data-v-8027050c${_scopeId2}></path><path d="M12.5001 14.75C12.5001 14.3358 12.8358 14 13.2501 14H16.7499C17.1642 14 17.4999 14.3358 17.4999 14.75C17.4999 15.1642 17.1642 15.5 16.7499 15.5H13.2501C12.8358 15.5 12.5001 15.1642 12.5001 14.75Z" data-v-8027050c${_scopeId2}></path><path d="M10.7803 7.71967C11.0732 8.01256 11.0732 8.48744 10.7803 8.78033L8.78033 10.7803C8.48744 11.0732 8.01256 11.0732 7.71967 10.7803L6.71967 9.78033C6.42678 9.48744 6.42678 9.01256 6.71967 8.71967C7.01256 8.42678 7.48744 8.42678 7.78033 8.71967L8.25 9.18934L9.71967 7.71967C10.0126 7.42678 10.4874 7.42678 10.7803 7.71967Z" data-v-8027050c${_scopeId2}></path><path d="M10.7803 14.2803C11.0732 13.9874 11.0732 13.5126 10.7803 13.2197C10.4874 12.9268 10.0126 12.9268 9.71967 13.2197L8.25 14.6893L7.78033 14.2197C7.48744 13.9268 7.01256 13.9268 6.71967 14.2197C6.42678 14.5126 6.42678 14.9874 6.71967 15.2803L7.71967 16.2803C8.01256 16.5732 8.48744 16.5732 8.78033 16.2803L10.7803 14.2803Z" data-v-8027050c${_scopeId2}></path><path d="M5.25 3C4.00736 3 3 4.00736 3 5.25V18.75C3 19.9926 4.00736 21 5.25 21H18.75C19.9926 21 21 19.9926 21 18.75V5.25C21 4.00736 19.9926 3 18.75 3H5.25ZM4.5 5.25C4.5 4.83579 4.83579 4.5 5.25 4.5H18.75C19.1642 4.5 19.5 4.83579 19.5 5.25V18.75C19.5 19.1642 19.1642 19.5 18.75 19.5H5.25C4.83579 19.5 4.5 19.1642 4.5 18.75V5.25Z" data-v-8027050c${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          width: "25px",
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0417\u0430\u0434\u0430\u043D\u0438\u044F"))}</p>`);
                    } else {
                      return [
          ...
          if (_push2) {
            if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("documents")) {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg class="dark:stroke-white stroke-black" width="25px" height="25px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId2}><path d="M5 8C5 5.17157 5 3.75736 5.87868 2.87868C6.75736 2 8.17157 2 11 2H13C15.8284 2 17.2426 2 18.1213 2.87868C19 3.75736 19 5.17157 19 8V16C19 18.8284 19 20.2426 18.1213 21.1213C17.2426 22 15.8284 22 13 22H11C8.17157 22 6.75736 22 5.87868 21.1213C5 20.2426 5 18.8284 5 16V8Z" stroke-width="1.5" data-v-8027050c${_scopeId2}></path><path d="M5 4.07617C4.02491 4.17208 3.36857 4.38885 2.87868 4.87873C2 5.75741 2 7.17163 2 10.0001V14.0001C2 16.8285 2 18.2427 2.87868 19.1214C3.36857 19.6113 4.02491 19.828 5 19.9239" stroke-width="1.5" data-v-8027050c${_scopeId2}></path><path d="M19 4.07617C19.9751 4.17208 20.6314 4.38885 21.1213 4.87873C22 5.75741 22 7.17163 22 10.0001V14.0001C22 16.8285 22 18.2427 21.1213 19.1214C20.6314 19.6113 19.9751 19.828 19 19.9239" stroke-width="1.5" data-v-8027050c${_scopeId2}></path><path d="M9 13H15" stroke-width="1.5" stroke-linecap="round" data-v-8027050c${_scopeId2}></path><path d="M9 9H15" stroke-width="1.5" stroke-linecap="round" data-v-8027050c${_scopeId2}></path><path d="M9 17H12" stroke-width="1.5" stroke-linecap="round" data-v-8027050c${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        class: "dark:stroke-white stroke-black",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0414\u043E\u043A\u0443\u043C\u0435\u043D\u0442\u044B"))}</p>`);
                  } else {
                    return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("sales")) {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041F\u0440\u043E\u0434\u0430\u0436\u0438"))}</p>`);
                  } else {
                    return [
              ...
              navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (unref(loadCurrentUser).user.role === "\u0410\u0434\u043C\u0438\u043D\u0438\u0441\u0442\u0440\u0430\u0442\u043E\u0440 \u0441\u0430\u0439\u0442\u0430") {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u0438"))}</p>`);
                  } else {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041A\u043E\u043C\u043F\u0430\u043D\u0438\u044F"))}</p>`);
                  }
                } else {
                  return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin") {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg class="dark:stroke-white stroke-black" fill="none" width="25px" height="25px" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId2}><path d="M5.04146 3C5.22009 2.6906 5.55022 2.5 5.90748 2.5L9.75278 2.5C10.11 2.5 10.4402 2.6906 10.6188 3L12.5415 6.33013C12.7201 6.63953 12.7201 7.02073 12.5415 7.33013L10.6188 10.6603C10.4402 10.9697 10.11 11.1603 9.75278 11.1603H5.90748C5.55022 11.1603 5.22009 10.9697 5.04146 10.6603L3.11881 7.33013C2.94017 7.02073 2.94017 6.63953 3.11881 6.33013L5.04146 3Z" data-v-8027050c${_scopeId2}></path><path d="M5.1216 13.2272C5.30023 12.9178 5.63036 12.7272 5.98762 12.7272H9.83292C10.1902 12.7272 10.5203 12.9178 10.6989 13.2272L12.6216 16.5574C12.8002 16.8668 12.8002 17.248 12.6216 17.5574L10.6989 20.8875C10.5203 21.1969 10.1902 21.3875 9.83292 21.3875H5.98762C5.63036 21.3875 5.30023 21.1969 5.1216 20.8875L3.19895 17.5574C3.02031 17.248 3.02031 16.8668 3.19895 16.5574L5.1216 13.2272Z" data-v-8027050c${_scopeId2}></path><path d="M14.1216 8.22723C14.3002 7.91783 14.6304 7.72723 14.9876 7.72723L18.8329 7.72723C19.1902 7.72723 19.5203 7.91783 19.6989 8.22723L21.6216 11.5574C21.8002 11.8668 21.8002 12.248 21.6216 12.5574L19.6989 15.8875C19.5203 16.1969 19.1902 16.3875 18.8329 16.3875H14.9876C14.6304 16.3875 14.3002 16.1969 14.1216 15.8875L12.1989 12.5574C12.0203 12.248 12.0203 11.8668 12.1989 11.5574L14.1216 8.22723Z" data-v-8027050c${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        class: "dark:stroke-white stroke-black",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0414\u0435\u043F\u0430\u0440\u0442\u0430\u043C\u0435\u043D\u0442\u044B"))}</p>`);
                  } else {
                    return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin") {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg class="fill-black dark:fill-white" width="25px" height="25px" viewBox="0 0 32 32" id="icon" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId2}><path d="M23,9h6a2,2,0,0,0,2-2V3a2,2,0,0,0-2-2H23a2,2,0,0,0-2,2V4H11V3A2,2,0,0,0,9,1H3A2,2,0,0,0,1,3V7A2,2,0,0,0,3,9H9a2,2,0,0,0,2-2V6h4V26a2.0023,2.0023,0,0,0,2,2h4v1a2,2,0,0,0,2,2h6a2,2,0,0,0,2-2V25a2,2,0,0,0-2-2H23a2,2,0,0,0-2,2v1H17V17h4v1a2,2,0,0,0,2,2h6a2,2,0,0,0,2-2V14a2,2,0,0,0-2-2H23a2,2,0,0,0-2,2v1H17V6h4V7A2,2,0,0,0,23,9Zm0-6h6V7H23ZM9,7H3V3H9ZM23,25h6v4H23Zm0-11h6v4H23Z" transform="translate(0 0.0049)" data-v-8027050c${_scopeId2}></path><rect id="_Transparent_Rectangle_" data-name="&lt;Transparent Rectangle&gt;" fill="none" width="32" height="32" data-v-8027050c${_scopeId2}></rect></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        class: "fill-black dark:fill-white",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0414\u0435\u0440\u0435\u0432\u043E"))}</p>`);
                  } else {
                    return [
            ...
            if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("objects")) {
              _push2(ssrRenderComponent(_sfc_main$3, {
                ...
                navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<svg width="25px" height="25px" class="stroke-black dark:stroke-white" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId2}><path d="M20.3873 7.1575L11.9999 12L3.60913 7.14978" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" data-v-8027050c${_scopeId2}></path><path d="M12 12V21" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" data-v-8027050c${_scopeId2}></path><path d="M11 2.57735C11.6188 2.22008 12.3812 2.22008 13 2.57735L19.6603 6.42265C20.2791 6.77992 20.6603 7.44017 20.6603 8.1547V15.8453C20.6603 16.5598 20.2791 17.2201 19.6603 17.5774L13 21.4226C12.3812 21.7799 11.6188 21.7799 11 21.4226L4.33975 17.5774C3.72094 17.2201 3.33975 16.5598 3.33975 15.8453V8.1547C3.33975 7.44017 3.72094 6.77992 4.33975 6.42265L11 2.57735Z" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round" data-v-8027050c${_scopeId2}></path></svg>`);
                  } else {
                    return [
                      (openBlock(), createBlock("svg", {
                        width: "25px",
                ...
                navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041E\u0431\u044A\u0435\u043A\u0442\u044B"))}</p>`);
                  } else {
                    return [
            ...
            if (_push2) {
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("task.create")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0421\u043A\u043B\u0430\u0434"))}</p>`);
                    } else {
                      return [
            ...
            if (_push2) {
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("chat")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navIcon: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<svg width="25px" height="25px" class="dark:stroke-white stroke-black" viewBox="0 0 60 60" xmlns="http://www.w3.org/2000/svg" fill="none" stroke="#000000" data-v-8027050c${_scopeId2}><line x1="16" y1="20" x2="48" y2="20" stroke-width="2" data-v-8027050c${_scopeId2}></line><line x1="16" y1="30" x2="48" y2="30" stroke-width="2" data-v-8027050c${_scopeId2}></line><line x1="16" y1="40" x2="48" y2="40" stroke-width="2" data-v-8027050c${_scopeId2}></line><path d="m56 56-12-4H17.16A9.16 9.16 0 0 1 8 42.84V17.16A9.16 9.16 0 0 1 17.16 8h29.68A9.16 9.16 0 0 1 56 17.16z" stroke-width="2" data-v-8027050c${_scopeId2}></path></svg>`);
                    } else {
                      return [
                        (openBlock(), createBlock("svg", {
                          width: "25px",
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u0427\u0430\u0442"))}</p>`);
                    } else {
                      return [
              ...
              if (unref(loadCurrentUser).user.role.name_en !== "admin" && isValidLink("file_manager")) {
                _push2(ssrRenderComponent(_sfc_main$3, {
                  ...
                  navLink: withCtx((_2, _push3, _parent3, _scopeId2) => {
                    if (_push3) {
                      _push3(`<p data-v-8027050c${_scopeId2}>${ssrInterpolate(_ctx.$t("\u041E\u0431\u043B\u0430\u043A\u043E"))}</p>`);
                    } else {
                      return [
      ...
      _push(`<div class="h-full transition-all duration-500 mx-auto" data-v-8027050c>`);
      _push(ssrRenderComponent(_sfc_main$a, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div data-v-8027050c${_scopeId}><svg width="30px" class="stroke-red-400" height="30px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-8027050c${_scopeId}><path d="M9 4.5H8C5.64298 4.5 4.46447 4.5 3.73223 5.23223C3 5.96447 3 7.14298 3 9.5V14.5C3 16.857 3 18.0355 3.73223 18.7678C4.46447 19.5 5.64298 19.5 8 19.5H9" stroke-width="1.5" data-v-8027050c${_scopeId}></path><path d="M9 6.4764C9 4.18259 9 3.03569 9.70725 2.4087C10.4145 1.78171 11.4955 1.97026 13.6576 2.34736L15.9864 2.75354C18.3809 3.17118 19.5781 3.37999 20.2891 4.25826C21 5.13652 21 6.40672 21 8.94711V15.0529C21 17.5933 21 18.8635 20.2891 19.7417C19.5781 20.62 18.3809 20.8288 15.9864 21.2465L13.6576 21.6526C11.4955 22.0297 10.4145 22.2183 9.70725 21.5913C9 20.9643 9 19.8174 9 17.5236V6.4764Z" stroke-width="1.5" data-v-8027050c${_scopeId}></path><path d="M12 11V13" stroke-width="1.5" stroke-linecap="round" data-v-8027050c${_scopeId}></path></svg></div>`);
            if (unref(loadCurrentUser).activeNav) {
              _push2(`<p class="font-medium dark:text-white text-black" data-v-8027050c${_scopeId}>${ssrInterpolate(_ctx.$t("\u0412\u044B\u0439\u0442\u0438"))}</p>`);
            } else {
              _push2(`<!---->`);
            }
          } else {
...
const TheNavigation = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-8027050c"]]);
...
//# sourceMappingURL=base-BC2-4Sbh.mjs.map
