import { a as useRouter, k as useSeoMeta, l as __nuxt_component_0$1 } from './server.mjs';
...
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrInterpolate, ssrRenderAttr, ssrRenderList, ssrRenderSlot } from 'vue/server-renderer';
...
import { _ as _sfc_main$8 } from './TheButton-CWTlbPGF.mjs';
import { _ as _sfc_main$9 } from './TheModal-DtMcuqX0.mjs';
import { _ as _sfc_main$a } from './TheFileInput-CCCWQ5kH.mjs';
import { Preview } from 'vue-advanced-cropper';
import { _ as _sfc_main$1$1, a as _sfc_main$b } from './TheChatAvatar-rd-hIRu1.mjs';
...
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    useAuthStore();
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "h-full" }, _attrs))} data-v-a2cc5a54>`);
...
const ChatNav = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-a2cc5a54"]]);
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    userStore.loadUserList({ query: "", user_type: "user-list/my-company", page: 1, limit: 1e4 });
    onUnmounted(() => {
...
//# sourceMappingURL=chat-Djdu18pt.mjs.map
