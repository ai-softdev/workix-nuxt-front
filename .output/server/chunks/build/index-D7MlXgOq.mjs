import { useSSRContext, defineComponent, ref, withCtx, createTextVNode, toDisplayString, unref, mergeProps, createSlots, openBlock, createBlock, createVNode, isRef, createCommentVNode, watchEffect, withDirectives, Fragment, renderList, vModelSelect, withModifiers, resolveComponent } from 'vue';
import { k as useSeoMeta } from './server.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderClass, ssrRenderAttr, ssrRenderSlot, ssrRenderList, ssrRenderStyle } from 'vue/server-renderer';
...
import { _ as _sfc_main$f } from './TheInput-BhoKAMvc.mjs';
                ...
                createVNode("div", null, [
                  ...
                  createVNode("form", {
                    onSubmit: withModifiers(($event) => {
                      var _a2;
                      unref(tasksList).create_task({ ...unref(createForm), performers: (_a2 = unref(filteredParticipants)) == null ? void 0 : _a2.filter((e) => e.value).map((i) => i.id).join(",") });
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$b, { "text-type": "pageTitle" }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
...
//# sourceMappingURL=index-D7MlXgOq.mjs.map
