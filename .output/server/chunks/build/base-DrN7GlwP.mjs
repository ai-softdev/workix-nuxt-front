...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><button class="px-2 w-full text-start transition-all"><div class="items-center flex justify-between max-sm:!justify-start">`);
...
//# sourceMappingURL=base-DrN7GlwP.mjs.map
